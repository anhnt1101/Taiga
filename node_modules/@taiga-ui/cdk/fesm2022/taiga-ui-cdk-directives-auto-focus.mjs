...
class AbstractTuiAutofocusHandler {
    ...
    get element() {
        return (this.el.nativeElement.querySelector(this.options.query) ??
...
const TUI_AUTOFOCUS_HANDLER = new InjectionToken(ngDevMode ? 'TUI_AUTOFOCUS_HANDLER' : '');
...
class TuiAutoFocus {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.25", ngImport: i0, type: TuiAutoFocus, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "19.2.25", type: TuiAutoFocus, isStandalone: true, selector: "[tuiAutoFocus]", inputs: { autoFocus: { classPropertyName: "autoFocus", publicName: "tuiAutoFocus", isSignal: true, isRequired: false, transformFunction: null } }, providers: TUI_AUTOFOCUS_PROVIDERS, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.25", ngImport: i0, type: TuiAutoFocus, decorators: [{
            type: Directive,
            args: [{
