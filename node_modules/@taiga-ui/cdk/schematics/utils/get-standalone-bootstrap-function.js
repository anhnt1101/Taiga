...
function getStandaloneBootstrapFunction(path) {
    return (0, get_named_import_references_1.getNamedImportReferences)('bootstrapApplication', '@angular/platform-browser', path)
        .map((ref) => ref.getParent())
        .find((node) => ng_morph_1.Node.isCallExpression(node));
}
//# sourceMappingURL=get-standalone-bootstrap-function.js.map