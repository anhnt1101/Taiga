...
exports.TUI_THICKNESS_COMMENT = void 0;
exports.migrateCssVariables = migrateCssVariables;
const ng_morph_1 = require("ng-morph");
const colored_log_1 = require("../../../utils/colored-log");
const add_comment_for_styles_1 = require("../../utils/add-comment-for-styles");
...
exports.TUI_THICKNESS_COMMENT = 'use --tui-thumb-size. Learn more: https://taiga-ui.dev/components/slider#size';
const TUI_DATA_LIST_SPACING_COMMENT = 'The tui-data-list spacing variables (padding and margin) have been removed. tui-data-list spacing is now fixed in the component and is no longer exposed as a CSS variable; restyle [tuiOption] (or tui-data-list) directly if you need different spacing.';
const TUI_TEXTAREA_HEIGHT_COMMENT = 'The tui-textarea height variable has been removed. The textarea moved to @taiga-ui/kit and auto-sizes to its content; control the height with the [min] and [max] row inputs (or set min-block-size on the element) instead.';
const DEPRECATED_VARS_WITH_COMMENT = [
    {
        sourceText: '--tui-thickness',
        comment: `TODO: (Taiga UI migration) ${exports.TUI_THICKNESS_COMMENT}`,
    },
    {
...
function migrateCssVariables(tree, options) {
    if (!options['skip-logs']) {
        (0, colored_log_1.infoLog)('Starting migration css variables...');
    }
    const fileSystem = (0, get_file_system_1.getFileSystem)(tree);
    (0, replace_text_1.replaceText)(FONT_VARIABLES_REPLACEMENTS);
    (0, add_comment_for_styles_1.addCommentForStylesFiles)(DEPRECATED_VARS_WITH_COMMENT);
    fileSystem.commitEdits();
    (0, ng_morph_1.saveActiveProject)();
    !options['skip-logs'] &&
        (0, colored_log_1.successLog)(`${colored_log_1.SMALL_TAB_SYMBOL}${colored_log_1.SUCCESS_SYMBOL} css variables migrated \n`);
}
//# sourceMappingURL=migrate-css-variables.js.map