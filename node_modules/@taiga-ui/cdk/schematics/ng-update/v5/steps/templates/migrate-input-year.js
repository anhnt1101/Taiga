...
function migrateInputYear({ resource, recorder, fileSystem, }) {
    ...
    elements.forEach((element) => {
        ...
        (0, replace_tag_1.replaceTag)(recorder, sourceCodeLocation, 'tui-input-year', 'tui-textfield', template, templateOffset);
        ...
        const calendarInsertOffset = ((_k = (_j = sourceCodeLocation === null || sourceCodeLocation === void 0 ? void 0 : sourceCodeLocation.endTag) === null || _j === void 0 ? void 0 : _j.startOffset) !== null && _k !== void 0 ? _k : 0) + templateOffset;
        ...
        for (const input of inputs) {
            input.attrs.forEach((attr) => {
                ...
                if (/^tuiTextfield$|^tuiTextfieldLegacy$/i.exec(attr.name)) {
                    ...
                    recorder.remove(templateOffset + startOffset, endOffset - startOffset);
                    recorder.insertRight(templateOffset + startOffset, `tuiInputYear${migrationAttrs}${placeholderAttr}`);
                }
            });
        }
    });
