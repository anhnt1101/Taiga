...
exports.migrateInputPhone = migrateInputPhone;
...
function migrateInputPhone({ resource, recorder, fileSystem, }) {
    ...
    elements.forEach((element) => {
        ...
        if (noEquivalentAttrs.length > 0) {
            ...
            const todoComment = [
                `<!-- ${insert_todo_1.TODO_MARK} tui-input-phone migration (see ${DOCS_LINK}):`,
...
//# sourceMappingURL=migrate-input-phone.js.map