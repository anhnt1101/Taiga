...
exports.migrateInputDate = migrateInputDate;
...
function migrateInputDate({ resource, recorder, fileSystem, }) {
    ...
    elements.forEach((element) => {
        ...
        if (noEquivalentAttrs.length > 0) {
            const todoComment = [
                `<!-- ${insert_todo_1.TODO_MARK} tui-input-date migration (see ${DOCS_LINK}):`,
...
//# sourceMappingURL=migrate-input-date.js.map