...
function addTuiModules({ mainClass, context, }) {
    ...
    (0, ng_morph_1.addProviderToNgModule)(mainClass, 'provideTaiga()', { unique: true });
    (0, add_unique_import_1.addUniqueImport)(mainModulePath, 'provideTaiga', '@taiga-ui/core');
...
function addRootTuiProvidersToBootstrapFn(bootstrapOptions) {
    (0, push_to_array_property_1.pushToObjectArrayProperty)(bootstrapOptions, 'providers', 'provideTaiga()');
    const modules = [];
...
//# sourceMappingURL=add-taiga-modules.js.map