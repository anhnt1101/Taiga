...
import * as i1 from "./scroll-ref.directive";
/**
...
export declare class TuiScrollbar {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TuiScrollbar, "tui-scrollbar", never, {}, {}, never, ["*"], true, [{ directive: typeof i1.TuiScrollRef; inputs: {}; outputs: {}; }]>;
}
