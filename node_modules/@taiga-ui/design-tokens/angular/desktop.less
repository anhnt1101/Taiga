...
[tuiTheme='light'] {
	...
	--tui-background-neutral-1-hover: var(--tui-const-dark-blue-alpha-9);  // Только для веба. Cостояние элементов c фоном neutral-1 при наведении
	--tui-background-neutral-1-pressed: var(--tui-const-dark-blue-alpha-11);  // Нажатое состояние элементов с фоном neutral-1
	...
	--tui-background-button-vertical-hover: var(--tui-const-blue-alpha-12);  // @Deprecated: Перенесен в component
	...
	--tui-background-overlay-glass-hover: var(--tui-const-black-alpha-48);  // Оверлей стеклянных поверхностей при наведении
	...
	--tui-component-tooltip: var(--tui-const-cool-gray-lighter-36);  // Фон для тултипов
	...
	--tui-component-button-vertical-hover: var(--tui-const-blue-alpha-12);  // Фон tui-button [vertical]. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	...
	--tui-service-underline-grayscale-pressed: var(--tui-const-black-alpha-40);  // Подчеркивание для монохромных ссылок
	...
	--tui-text-primary-hover: var(--tui-const-black-alpha-50);  // Основной текст и иконки фонах base, elevation, neutral при наведении
	--tui-text-primary-pressed: var(--tui-const-black-alpha-40);  // Основной текст и иконки фонах base, elevation, neutral при нажатии
	...
	--tui-text-tertiary: var(--tui-const-black-alpha-40);  // Лейблы задизейбленных кнопок, дисклеймеры
	--tui-text-tertiary-hover: var(--tui-const-black-alpha-60);  // Лейблы задизейбленных кнопок, дисклеймеры при наведении
	--tui-text-tertiary-pressed: var(--tui-const-black-alpha-70);  // Лейблы задизейбленных кнопок, дисклеймеры, дисклеймеры при нажатии
	...
	--tui-shadow-small-hover: 0px 14px 42px 0px rgba(0, 0, 0, 0.12);
	...
	--tui-shadow-popup: 0px 8px 28px 0px rgba(0, 0, 0, 0.16);  // Тень для карточек, всплывающих поверх контента: например попап-онбординг
}
...
[tuiTheme='dark'] {
	...
	--tui-background-elevation-3: var(--tui-const-black-lighter-32);  // Фон элементов, возвышающихся над всем остальным контентом. Например, всплывающих подсказок
	...
	--tui-background-neutral-1-on-elevation-1: var(--tui-const-black-lighter-22);  // Непрозрачные контейнеры с минимальным контрастом на фоне elevation-1, не имеющие тени в светлой теме
	...
	--tui-background-button-vertical-hover: var(--tui-const-blue-alpha-20);  // @Deprecated: Перенесен в component
	...
	--tui-background-tooltip: var(--tui-const-white);  // @Deprecated: перенесли в группу component
	--tui-background-thumbnail-card-badge: var(--tui-const-black-alpha-12);  // @Deprecated: перенесли в группу component
	...
	--tui-component-tooltip: var(--tui-const-white);  // Фон для тултипов
	--tui-component-badge-notification: var(--tui-const-red);  // Контейнеры нотификационных бейджей. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-button-close-on-light: var(--tui-const-black-alpha-40);  // Фон кнопки закрытия на светлом фоне. не меняется при переключении темы. бывший цвет neutral-3-on-light. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	...
	--tui-component-button-vertical-hover: var(--tui-const-blue-alpha-20);  // Фон tui-button [vertical]. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	...
	--tui-text-action-hover: var(--tui-const-blue-darker-74);  // Только для веба. Состояние текста при наведении
	--tui-text-action-pressed: var(--tui-const-blue-darker-40);  // Нажатое состояние интерактивного текста. Заменяет цвет engaging-pressed и accent-pressed
	--tui-text-action-on-dark: var(--tui-const-blue-darker-72);  // Текст и иконки интерактивного текста на тёмных фонах
	--tui-text-accent: var(--tui-const-blue);  // @Deprecated: Заменён на цвет action
	--tui-text-accent-pressed: var(--tui-const-blue-darker-46);  // @Deprecated: Заменён на цвет action-pressed
