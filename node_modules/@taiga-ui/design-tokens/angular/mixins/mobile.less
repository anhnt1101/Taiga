.tui-theme-mobile-light() {
	...
	--tui-background-elevation-2: var(--tui-const-white);  // Фон карточек, лежащих на фоне elevation-1
	...
	--tui-background-neutral-1: var(--tui-const-cool-gray-alpha-3);  // Прозрачные контейнеры с минимальным контрастом на фонах base, elevation и neutral. Второстепенные кнопки, карточки без тени, задизейбленные кнопки и т.д.
	...
	--tui-background-neutral-1-pressed: var(--tui-const-cool-gray-alpha-6);  // Нажатое состояние элементов с фоном neutral-1
	--tui-background-neutral-1-pressed-on-light: var(--tui-const-black-alpha-6);  // @Deprecated: коррекция названия на neutral-1-on-light-pressed
	--tui-background-neutral-1-pressed-on-dark: var(--tui-const-white-alpha-15);  // @Deprecated: коррекция названия на neutral-1-on-dark-pressed
	--tui-background-neutral-1-on-light-pressed: var(--tui-const-black-alpha-6);  // Нажатое состояние элементов с фоном neutral-1-on-light, не меняется при переключении темы
	--tui-background-neutral-1-on-dark-pressed: var(--tui-const-white-alpha-15);  // Нажатое состояние элементов с фоном neutral-1-on-dark, не меняется при смене темы
	--tui-background-neutral-2: var(--tui-const-cool-gray-alpha-6);  // Прозрачные контейнеры маленьких размеров
	--tui-background-neutral-2-pressed: var(--tui-const-cool-gray-alpha-12);  // Прозрачные контейнеры со средним контрастом. Нажатое состояние элементов с цветом neutral-2
	...
	--tui-background-neutral-2-on-dark-pressed: var(--tui-const-white-alpha-20);  // Прозрачные контейнеры со слабым контрастом на темных цветных фонах, не меняется при смене темы
	...
	--tui-background-accent-1-pressed: var(--tui-const-yellow-darker-60);  // Фоны акцентных кнопок, бейджей и т.д. при нажатии
	--tui-background-accent-2: var(--tui-const-blue);  // Фоны акцентных кнопок, бейджей и т.д.
	--tui-background-accent-2-pressed: var(--tui-const-blue-darker-52);  // Фоны акцентных кнопок, бейджей и т.д.
	--tui-background-accent-opposite: var(--tui-const-black);  // Фон, противоположный base: в белой теме — черный, в темной теме — белый
	--tui-background-accent-opposite-pressed: var(--tui-const-cool-gray-lighter-18);  // Фон, противоположный base при нажатии: в белой теме — черный, в темной теме — белый
	--tui-background-accent-on-light: var(--tui-const-black);  // Контрастные контейнеры на светлых фонах, не меняется при смене темы
	--tui-background-accent-on-light-pressed: var(--tui-const-black-lighter-16);  // Контрастные контейнеры при нажатии на светлых фонах, не меняется при смене темы.
	--tui-background-accent-on-dark: var(--tui-const-white);  // Контрастные контейнеры на темных фонах, не меняется при смене темы
	--tui-background-accent-on-dark-pressed: var(--tui-const-cool-gray-lighter-97);  // Контрастные контейнеры при нажатии на темных фонах, не меняется при смене темы.
	--tui-background-button-close-on-light: var(--tui-const-black-alpha-40);  // @Deprecated: Перенесен в component
	--tui-background-button-close-on-dark: var(--tui-const-white-alpha-50);  // @Deprecated: Заменен на overlay-glass-on-dark
	--tui-background-badge-notification: var(--tui-const-red);  // @Deprecated: Перенесен в группу component
	--tui-background-toggle: var(--tui-const-cool-gray-alpha-12);  // @Deprecated: Заменен на background.neutral-2
	--tui-background-button-vertical: var(--tui-const-blue-alpha-8);  // @Deprecated: Перенесен в component
	--tui-background-button-vertical-pressed: var(--tui-const-blue-alpha-16);  // @Deprecated: Перенесен в component
	...
	--tui-background-progress-bar: var(--tui-const-cool-gray-alpha-6);  // @Deprecated: Перенесен в группу component
	--tui-background-tooltip: var(--tui-const-cool-gray-lighter-36);  // @Deprecated: перенесли в группу component
	--tui-background-thumbnail-card-badge: var(--tui-const-black-alpha-12);  // @Deprecated: перенесли в группу component
	--tui-background-overlay-glass: var(--tui-const-black-alpha-40);  // Оверлей стеклянных поверхностей
	--tui-background-overlay-glass-pressed: var(--tui-const-black-alpha-60);  // Оверлей стеклянных поверхностей при нажатии
	...
	--tui-background-overlay-glass-matte: var(--tui-const-white-alpha-80);  // Оверлей матовых стеклянных поверхностей, не меняется при смене темы.
	...
	--tui-border-normal-pale: var(--tui-const-cool-gray-alpha-7);  // Бледные бордеры и сепараторы на основных фонах
	--tui-border-normal-opaque: var(--tui-const-cool-gray-lighter-90);  // Бордеры и сепараторы на основных фонах без прозрачности
	--tui-border-normal-pale-opaque: var(--tui-const-cool-gray-lighter-94);  // Бледные непрозрачные бордеры и сепараторы на основных фонах
	--tui-border-normal-strong: var(--tui-const-cool-gray-alpha-32);  // Бордеры и сепараторы на основных фонах
	--tui-border-selected: var(--tui-const-blue);  // Обводка выделенных элементов
	--tui-border-selected-grayscale: var(--tui-const-cool-gray-lighter-36);  // Обводка выделенных элементов
	...
	--tui-border-on-dark: var(--tui-const-white-alpha-10);  // Обводка, отделяющая цветные элементы на темных фонах
	--tui-brand-element-t-ai-assistant: #9A6BFF;  // Цвет Ai Assistant для текста и иконок
	--tui-brand-element-t-ai-assistant-pale: #9A6BFF1A;  // Цвет Ai Assistant для фонов и поверхностей
	--tui-brand-element-t-insurance: #27AFA5;  // Цвет Т-Страхования для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-t-insurance-pale: #27AFA51A;  // Цвет Т-Страхования для фонов и поверхностей
	--tui-brand-element-t-mobile: #5848C3;  // Цвет Т-Мобайл для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-t-mobile-pale: #5848C31A;  // Цвет Т-Мобайл для фонов и поверхностей
	--tui-brand-element-t-business: #8D6040;  // Цвет Т-Бизнес для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-t-business-pale: #8D60401A;  // Цвет Т-Бизнес для фонов и поверхностей
	--tui-brand-element-t-invest: #6A6A7C;  // Цвет Т-Инвестции для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-t-invest-pale: #6A6A7C1A;  // Цвет Т-Инвестции для фонов и поверхностей
	--tui-brand-element-pro: #68CF08;  // Цвет Pro для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-pro-pale: #68CF081A;  // Цвет Pro для фонов и поверхностей
	--tui-brand-element-premium: #4972CF;  // Цвет Premium для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-premium-pale: #4972CF1A;  // Цвет Premium для фонов и поверхностей
	--tui-brand-element-private: #41414D;  // Цвет Private для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-private-pale: #41414D1A;  // Цвет Private для фонов и поверхностей
	--tui-brand-t-bank: #FFDD2D;  // Фирменный цвет. Используется, например, в бейдже подписки Team
	--tui-brand-pro: #85E808;  // Цвет подписки Pro, для фонов кнопок, бейджей и т.д.
	--tui-brand-pro-alt-1: #333333;  // Дополнительный цвет подписки Pro.
	--tui-brand-premium: #4972CF;  // Цвет подписки Premium, для фонов кнопок, бейджей и т.д.
	--tui-brand-premium-pressed: #3460CA;  // нажатое состояние цвета подписки Premium.
	...
	--tui-brand-t-ai-assistant: #9A6BFF;  // Фирменный цвет Ai Assistant
	...
	--tui-brand-private-alt-1: #A1A1B2;  // Допольнительный цвет подписки Private
	...
	--tui-chart-state-positive-accent: var(--tui-const-green);  // Основной цвет графиков с позитивным контекстом
	--tui-chart-state-positive-pale: var(--tui-const-green-alpha-25);  // Цвет графиков с позитивным контекстом когда данных недостаточно
	--tui-chart-state-positive-prognosis: var(--tui-const-green-alpha-50);  // Цвет графиков с позитивным контекстом для прогноза
	--tui-chart-state-negative-accent: var(--tui-const-red);  // Основной цвет графиков с негативным контекстом
	--tui-chart-state-negative-pale: var(--tui-const-red-alpha-25);  // Цвет графиков с негативным контекстом когда данных недостаточно
	--tui-chart-state-negative-prognosis: var(--tui-const-red-alpha-50);  // Цвет графиков с негативным контекстом для прогноза
	--tui-chart-state-warning-accent: var(--tui-const-orange-darker-48);  // Основной цвет графиков с негативным контекстом
	--tui-chart-state-warning-pale: var(--tui-const-orange-darker-48-alpha-25);  // Цвет графиков с негативным контекстом когда данных недостаточно
	--tui-chart-state-warning-prognosis: var(--tui-const-orange-darker-48-alpha-50);  // Цвет графиков с негативным контекстом для прогноза
	--tui-chart-series-primary-accent: var(--tui-const-blue);  // Основной акцентный цвет для графиков без контекста
	--tui-chart-series-primary-accent-pale: var(--tui-const-blue-alpha-25);  // Основной акцентный цвет для графиков без контекста когда данных недостаточно
	--tui-chart-series-primary-accent-prognosis: var(--tui-const-blue-alpha-50);  // Основной акцентный цвет для графиков без контекста для прогноза
	--tui-chart-series-additional1-accent: var(--tui-const-turquoise-darker-36);  // Первый дополнительный акцентный цвет для графиков без контекста
	--tui-chart-series-additional1-accent-pale: var(--tui-const-turquoise-darker-36-alpha-25);  // Первый дополнительный акцентный цвет для графиков без контекста когда данных недостаточно
	--tui-chart-series-additional1-accent-prognosis: var(--tui-const-turquoise-darker-36-alpha-50);  // Первый дополнительный акцентный цвет для графиков без контекста для прогноза
	--tui-chart-series-additional2-accent: #986DD4;  // Второй дополнительный акцентный цвет для графиков без контекста
	--tui-chart-series-additional2-accent-pale: #986DD440;  // Второй дополнительный акцентный цвет для графиков без контекста когда данных недостаточно
	--tui-chart-series-additional2-accent-prognosis: #986DD480;  // Второй дополнительный акцентный цвет для графиков без контекста для прогноза
	--tui-chart-gray-primary: var(--tui-const-black-lighter-20);  // Основной серый цвет для графиков без контекста
	--tui-chart-gray-no-data: var(--tui-const-cool-gray-lighter-60);  // Cерый цвет для графиков без контекста когда нет данных
	--tui-chart-gray-prognosis: var(--tui-const-cool-gray-lighter-85);  // Cерый цвет для графиков без контекста  для прогноза
	--tui-chart-gray-inactive: var(--tui-const-cool-gray-lighter-93);  // Cерый цвет для графиков без контекста  для прогноза
	...
	--tui-component-input-background-autofill: var(--tui-const-yellow-darker-88);  // @Deprecated: Заменён на service.autofill-background
	--tui-component-progress-bar: var(--tui-const-cool-gray-alpha-6);  // Пустая полоска прогресс-баров. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-tooltip: var(--tui-const-blue);  // Фон для тултипов
	--tui-component-badge-notification: var(--tui-const-red);  // Контейнеры нотификационных бейджей. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-button-close-on-light: var(--tui-const-black-alpha-40);  // Фон кнопки закрытия на светлом фоне. не меняется при переключении темы. бывший цвет neutral-3-on-light. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-button-vertical: var(--tui-const-blue-alpha-8);  // Фон tui-button [vertical]. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-button-vertical-pressed: var(--tui-const-blue-alpha-16);  // Фон tui-button [vertical] при нажатии и наведении. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-thumbnail-card-badge: var(--tui-const-black-alpha-12);  // Прозрачный контейнер бейджа на миниатюре карты. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	...
	--tui-const-yellow-darker-54-alpha-25: #F5970040;  // hsL=54, 25% opacity
	--tui-const-yellow-darker-54-alpha-50: #F5970080;  // hsL=54, 50% opacity
	...
	--tui-const-green-alpha-25: #00B92D40;  // 25% opacity
	...
	--tui-const-green-alpha-50: #00B92D80;  // 50% opacity
	--tui-const-green-lighter-42-alpha-25: #00D63540;  // hsL=42, 25% opacity
	...
	--tui-const-green-lighter-42-alpha-50: #00D63580;  // hsL=42, 50% opacity
	...
	--tui-const-blue-darker-70: #66A3FF;  // hsL=70
	...
	--tui-const-blue-darker-70-alpha-25: #66A3FF40;  // hsL=70, 25% opacity
	--tui-const-blue-darker-70-alpha-50: #66A3FF80;  // hsL=70, 50% opacity
	...
	--tui-const-blue-alpha-25: #428BF940;  // 25% opacity
	...
	--tui-const-blue-alpha-50: #428BF980;  // 50% opacity
	...
	--tui-const-red-alpha-25: #F5222240;  // 25% opacity
	...
	--tui-const-red-alpha-50: #F5222280;  // 50% opacity
	...
	--tui-const-red-lighter-65-alpha-25: #F5222240;  // hsL=65, 25% opacity
	--tui-const-red-lighter-65-alpha-50: #F5222280;  // hsL=65, 50% opacity
	...
	--tui-const-black-alpha-16: #00000029;  // 16% opacity
	--tui-const-black-alpha-14: #00000024;  // 14% opacity
	...
	--tui-const-black-lighter-32: #525252;
	--tui-const-black-lighter-55: #8C8C8C;
	...
	--tui-const-cool-gray-lighter-55: #838B95;
	...
	--tui-const-orange-darker-48-alpha-25: #F5920040;  // hsL=48, 25% opacity
	--tui-const-orange-darker-48-alpha-50: #F5920080;  // hsL=48, 50% opacity
	...
	--tui-const-turquoise-darker-40-alpha-25: #0AC2AF40;  // hsL=40, 25% opacity
	--tui-const-turquoise-darker-40-alpha-50: #0AC2AF40;  // hsL=40, 50% opacity
	--tui-const-turquoise-darker-36: #09AE9E;  // hsL=36
	--tui-const-turquoise-darker-36-alpha-25: #09AE9E40;  // hsL=36, 25% opacity
	--tui-const-turquoise-darker-36-alpha-50: #09AE9E80;  // hsL=36, 50% opacity
	...
	--tui-icon-pressed: var(--tui-const-black-lighter-20);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-icon-normal: var(--tui-const-cool-gray-alpha-22);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-icon-action: var(--tui-const-blue);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-icon-action-pressed: var(--tui-const-blue-darker-46);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-icon-on-dark: var(--tui-const-white);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-service-autofill-background: var(--tui-const-yellow-darker-88);  // Цвет фона при автозаполнении форм
	--tui-service-skeleton: var(--tui-const-black-alpha-3);  // Цвет для шиммеров, отображаемых при загрузке экрана
	...
	--tui-service-underline-grayscale-pressed: var(--tui-const-cool-gray-lighter-60);  // Подчеркивание для монохромных ссылок
	...
	--tui-service-underline-monochrome: var(--tui-const-black-alpha-24);  // @Deprecated: Заменён на цвет underline-grayscale
	...
	--tui-text-primary: var(--tui-const-black-lighter-20);  // Основной текст и иконки фонах base, elevation, neutral
	--tui-text-primary-pressed: var(--tui-const-cool-gray-lighter-36);  // Основной текст и иконки фонах base, elevation, neutral при нажатии
	--tui-text-primary-on-light: var(--tui-const-black-lighter-20);  // Основной текст и иконки на светлых фонах, не меняется при смене темы
	--tui-text-primary-on-light-pressed: var(--tui-const-black-lighter-60);  // Основной текст и иконки на светлых фонах, не меняется при смене темы
	...
	--tui-text-secondary: var(--tui-const-cool-gray-lighter-60);  // Второстепенный текст на фонах base, elevation, neutral
	--tui-text-secondary-pressed: var(--tui-const-cool-gray-lighter-36);  // Второстепенный текст на фонах base, elevation, neutral при нажатии
	...
	--tui-text-tertiary: var(--tui-const-cool-gray-alpha-22);  // Лейблы задизейбленных кнопок, дисклеймеры
	--tui-text-tertiary-pressed: var(--tui-const-cool-gray-alpha-56);  // Лейблы задизейбленных кнопок, дисклеймеры, дисклеймеры при нажатии
	--tui-text-tertiary-on-light: var(--tui-const-cool-gray-alpha-22);  // Лейблы задизейбленных кнопок, дисклеймеры на светлых фонах, не меняется при смене темы
	--tui-text-tertiary-on-dark: var(--tui-const-white-alpha-30);  // Лейблы задизейбленных кнопок, дисклеймеры на светлых фонах, не меняется при смене темы
	...
	--tui-text-action-on-dark: var(--tui-const-blue-darker-70);  // Текст и иконки интерактивного текста на тёмных фонах
	...
	--tui-text-positive: var(--tui-const-green);  // Текст позитивного лейбла, например пополнение счета или рост цены акций
	--tui-text-positive-on-dark: var(--tui-const-green-lighter-42);  // Текст позитивного лейбла на тёмном фоне, например пополнение счета или рост цены акций
...
.tui-theme-mobile-dark() {
	--tui-background-base: var(--tui-const-black);  // Основной фон приложений. Отличается на iOS, Android и Desktop
	--tui-background-base-alt: var(--tui-const-black-lighter-20);  // Альтернативный основной фон, в тёмной теме в вебе равен base
	--tui-background-elevation-1: var(--tui-const-cool-gray-lighter-11);  // Фон шторок, модальных экранов и карточек, лежащих на фоне base
	--tui-background-elevation-2: var(--tui-const-cool-gray-lighter-18);  // Фон карточек, лежащих на фоне elevation-1
	--tui-background-elevation-3: var(--tui-const-black-lighter-30);  // Фон элементов, возвышающихся над всем остальным контентом. Например, всплывающих подсказок
	...
	--tui-background-neutral-1-on-base: var(--tui-const-cool-gray-lighter-11);  // Непрозрачные контейнеры с минимальным контрастом на фоне base, не имеющие тени в светлой теме
	...
	--tui-background-neutral-1-pressed: var(--tui-const-white-alpha-15);  // Нажатое состояние элементов с фоном neutral-1
	--tui-background-neutral-1-pressed-on-light: var(--tui-const-black-alpha-6);  // @Deprecated: коррекция названия на neutral-1-on-light-pressed
	--tui-background-neutral-1-pressed-on-dark: var(--tui-const-white-alpha-15);  // @Deprecated: коррекция названия на neutral-1-on-dark-pressed
	--tui-background-neutral-1-on-light-pressed: var(--tui-const-black-alpha-6);  // Нажатое состояние элементов с фоном neutral-1-on-light, не меняется при переключении темы
	--tui-background-neutral-1-on-dark-pressed: var(--tui-const-white-alpha-15);  // Нажатое состояние элементов с фоном neutral-1-on-dark, не меняется при смене темы
	--tui-background-neutral-2: var(--tui-const-white-alpha-15);  // Прозрачные контейнеры маленьких размеров
	--tui-background-neutral-2-pressed: var(--tui-const-white-alpha-20);  // Прозрачные контейнеры со средним контрастом. Нажатое состояние элементов с цветом neutral-2
	--tui-background-neutral-2-on-light: var(--tui-const-black-alpha-6);  // @Deprecated: Изменен на neutral-1-pressed-on-light
	--tui-background-neutral-2-on-dark: var(--tui-const-white-alpha-15);  // Прозрачные контейнеры со слабым контрастом на темных цветных фонах, не меняется при смене темы
	--tui-background-neutral-2-on-dark-pressed: var(--tui-const-white-alpha-20);  // Прозрачные контейнеры со слабым контрастом на темных цветных фонах, не меняется при смене темы
	...
	--tui-background-accent-opposite-pressed: var(--tui-const-cool-gray-lighter-97);  // Фон, противоположный base при нажатии: в белой теме — черный, в темной теме — белый
	--tui-background-accent-on-light: var(--tui-const-black);  // Контрастные контейнеры на светлых фонах, не меняется при смене темы
	--tui-background-accent-on-light-pressed: var(--tui-const-black-lighter-16);  // Контрастные контейнеры при нажатии на светлых фонах, не меняется при смене темы.
	--tui-background-accent-on-dark: var(--tui-const-white);  // Контрастные контейнеры на темных фонах, не меняется при смене темы
	--tui-background-accent-on-dark-pressed: var(--tui-const-cool-gray-lighter-97);  // Контрастные контейнеры при нажатии на темных фонах, не меняется при смене темы.
	...
	--tui-background-button-vertical: var(--tui-const-blue-alpha-16);  // @Deprecated: Перенесен в component
	--tui-background-button-vertical-pressed: var(--tui-const-blue-alpha-24);  // @Deprecated: Перенесен в component
	--tui-background-button-glass-on-dark: var(--tui-const-white-alpha-30);  // @Deprecated: Заменен на overlay-glass-on-dark
	--tui-background-button-glass-on-light: var(--tui-const-black-alpha-40);  // @Deprecated: Заменен на overlay-glass-on-light
	--tui-background-progress-bar: var(--tui-const-white-alpha-15);  // @Deprecated: Перенесен в группу component
	--tui-background-tooltip: var(--tui-const-cool-gray-lighter-51);  // @Deprecated: перенесли в группу component
	--tui-background-thumbnail-card-badge: var(--tui-const-black-alpha-12);  // @Deprecated: перенесли в группу component
	...
	--tui-background-overlay-glass-on-light: var(--tui-const-black-alpha-40);  // Оверлей стеклянных поверхностей на светлых фонах, не меняется при смене темы
	--tui-background-overlay-glass-on-light-pressed: var(--tui-const-black-alpha-60);  // Оверлей стеклянных поверхностей при нажатии на светлых фонах, не меняется при смене темы.
	--tui-background-overlay-glass-matte: var(--tui-const-black-alpha-80);  // Оверлей матовых стеклянных поверхностей, не меняется при смене темы.
	--tui-background-overlay-on-image: var(--tui-const-black-alpha-30);  // Оверлей поверх изображений, не меняется от темы.
	--tui-border-normal: var(--tui-const-white-alpha-19);  // Бордеры и сепараторы на основных фонах
	--tui-border-normal-pale: var(--tui-const-white-alpha-13);  // Бледные бордеры и сепараторы на основных фонах
	--tui-border-normal-opaque: var(--tui-const-black-lighter-19);  // Бордеры и сепараторы на основных фонах без прозрачности
	--tui-border-normal-pale-opaque: var(--tui-const-black-lighter-13);  // Бледные непрозрачные бордеры и сепараторы на основных фонах
	...
	--tui-border-on-light: var(--tui-const-black-alpha-3);  // Обводка, отделяющая цветные элементы от светлого фонов
	--tui-border-on-dark: var(--tui-const-white-alpha-10);  // Обводка, отделяющая цветные элементы на темных фонах
	--tui-brand-element-t-ai-assistant: #BD9EFF;  // Цвет Ai Assistant для текста и иконок
	--tui-brand-element-t-ai-assistant-pale: #BD9EFF4D;  // Цвет Ai Assistant для фонов и поверхностей
	--tui-brand-element-t-insurance: #90E5DF;  // Цвет Т-Страхования для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-t-insurance-pale: #90E5DF4D;  // Цвет Т-Страхования для фонов и поверхностей
	--tui-brand-element-t-mobile: #8D80E3;  // Цвет Т-Мобайл для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-t-mobile-pale: #8D80E34D;  // Цвет Т-Мобайл для фонов и поверхностей
	--tui-brand-element-t-business: #D4B788;  // Цвет Т-Бизнес для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-t-business-pale: #D4B7884D;  // Цвет Т-Бизнес для фонов и поверхностей
	--tui-brand-element-t-invest: #D4D1D8;  // Цвет Т-Инвестции для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-t-invest-pale: #D4D1D84D;  // Цвет Т-Инвестции для фонов и поверхностей
	--tui-brand-element-pro: #85E808;  // Цвет Pro для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-pro-pale: #85E8084D;  // Цвет Pro для фонов и поверхностей
	--tui-brand-element-premium: #7DA4FF;  // Цвет Premium для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-premium-pale: #7DA4FF4D;  // Цвет Premium для фонов и поверхностей
	--tui-brand-element-private: #F5F5F7;  // Цвет Private для акцентных элементов, таких как текст, иконки, бордеры
	--tui-brand-element-private-pale: #F5F5F74D;  // Цвет Private для фонов и поверхностей
	--tui-brand-t-bank: #FFDD2D;  // Фирменный цвет. Используется, например, в бейдже подписки Team
	--tui-brand-pro: #85E808;  // Цвет подписки Pro, для фонов кнопок, бейджей и т.д.
	--tui-brand-pro-alt-1: #333333;  // Дополнительный цвет подписки Pro.
	--tui-brand-premium: #4972CF;  // Цвет подписки Premium, для фонов кнопок, бейджей и т.д.
	...
	--tui-brand-t-pro: var(--tui-brand-pro);  // @Deprecated: Заменён на pro
	--tui-brand-t-private: var(--tui-brand-private);  // @Deprecated: Заменён на private
	--tui-chart-state-positive-accent: var(--tui-const-green-lighter-42);  // Основной цвет графиков с позитивным контекстом
	--tui-chart-state-positive-pale: var(--tui-const-green-lighter-42-alpha-25);  // Цвет графиков с позитивным контекстом когда данных недостаточно
	--tui-chart-state-positive-prognosis: var(--tui-const-green-lighter-42-alpha-50);  // Цвет графиков с позитивным контекстом для прогноза
	--tui-chart-state-negative-accent: var(--tui-const-red-lighter-65);  // Основной цвет графиков с негативным контекстом
	--tui-chart-state-negative-pale: var(--tui-const-red-lighter-65-alpha-25);  // Цвет графиков с негативным контекстом когда данных недостаточно
	--tui-chart-state-negative-prognosis: var(--tui-const-red-lighter-65-alpha-50);  // Цвет графиков с негативным контекстом для прогноза
	--tui-chart-state-warning-accent: var(--tui-const-yellow-darker-54);  // Основной цвет графиков с негативным контекстом
	--tui-chart-state-warning-pale: var(--tui-const-yellow-darker-54-alpha-25);  // Цвет графиков с негативным контекстом когда данных недостаточно
	--tui-chart-state-warning-prognosis: var(--tui-const-yellow-darker-54-alpha-50);  // Цвет графиков с негативным контекстом для прогноза
	--tui-chart-series-primary-accent: var(--tui-const-blue-darker-70);  // Основной акцентный цвет для графиков без контекста
	--tui-chart-series-primary-accent-pale: var(--tui-const-blue-darker-70-alpha-25);  // Основной акцентный цвет для графиков без контекста когда данных недостаточно
	--tui-chart-series-primary-accent-prognosis: var(--tui-const-blue-darker-70-alpha-50);  // Основной акцентный цвет для графиков без контекста для прогноза
	--tui-chart-series-additional1-accent: var(--tui-const-turquoise-darker-40);  // Первый дополнительный акцентный цвет для графиков без контекста
	--tui-chart-series-additional1-accent-pale: var(--tui-const-turquoise-darker-40-alpha-25);  // Первый дополнительный акцентный цвет для графиков без контекста когда данных недостаточно
	--tui-chart-series-additional1-accent-prognosis: var(--tui-const-turquoise-darker-40-alpha-50);  // Первый дополнительный акцентный цвет для графиков без контекста для прогноза
	--tui-chart-series-additional2-accent: #B078FF;  // Второй дополнительный акцентный цвет для графиков без контекста
	--tui-chart-series-additional2-accent-pale: #B078FF40;  // Второй дополнительный акцентный цвет для графиков без контекста когда данных недостаточно
	--tui-chart-series-additional2-accent-prognosis: #B078FF80;  // Второй дополнительный акцентный цвет для графиков без контекста для прогноза
	--tui-chart-gray-primary: var(--tui-const-cool-gray-lighter-97);  // Основной серый цвет для графиков без контекста
	--tui-chart-gray-no-data: var(--tui-const-cool-gray-lighter-60);  // Cерый цвет для графиков без контекста когда нет данных
	--tui-chart-gray-prognosis: var(--tui-const-cool-gray-lighter-36);  // Cерый цвет для графиков без контекста  для прогноза
	--tui-chart-gray-inactive: var(--tui-const-cool-gray-lighter-18);  // Cерый цвет для графиков без контекста  для прогноза
	--tui-chart-categorical-01: var(--tui-const-sea-blue);
	--tui-chart-categorical-02: var(--tui-const-purple-darker-72);
	--tui-chart-categorical-03: var(--tui-const-coral-darker-60);
	--tui-chart-categorical-04: var(--tui-const-turquoise);
	...
	--tui-component-progress-bar: var(--tui-const-white-alpha-15);  // Пустая полоска прогресс-баров. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-tooltip: var(--tui-const-blue);  // Фон для тултипов
	--tui-component-badge-notification: var(--tui-const-red);  // Контейнеры нотификационных бейджей. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-button-close-on-light: var(--tui-const-black-alpha-40);  // Фон кнопки закрытия на светлом фоне. не меняется при переключении темы. бывший цвет neutral-3-on-light. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-button-vertical: var(--tui-const-blue-alpha-16);  // Фон tui-button [vertical]. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-button-vertical-pressed: var(--tui-const-blue-alpha-24);  // Фон tui-button [vertical] при нажатии и наведении. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-component-thumbnail-card-badge: var(--tui-const-black-alpha-12);  // Прозрачный контейнер бейджа на миниатюре карты. Временный компонентный токен, существует пока не зарелизятся токены 2.0.
	--tui-const-yellow: #FFDD2D;  // N9
	--tui-const-yellow-darker-88: #FFF5C2;
	--tui-const-yellow-darker-60: #FFCD33;  // N9 pressed, hsL=60
	...
	--tui-foreground-border-on-light: var(--tui-const-black-alpha-3);  // @Deprecated: Перенесен в отдельную группу
	--tui-foreground-border-on-dark: var(--tui-const-white-alpha-10);  // @Deprecated: Перенесен в отдельную группу
	--tui-icon-pressed: var(--tui-const-cool-gray-lighter-97);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-icon-normal: var(--tui-const-white-alpha-30);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-icon-action: var(--tui-const-blue);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-icon-action-pressed: var(--tui-const-blue-darker-46);  // @Deprecated: Для иконок используем цвета из группы text
	--tui-icon-on-dark: var(--tui-const-white);  // @Deprecated: Для иконок используем цвета из группы text
	...
	--tui-service-highlight-background: var(--tui-const-yellow-alpha-32);  // Фон под выделенным текстом
	--tui-service-backdrop: var(--tui-const-black-alpha-50);  // Затемнение на фоне модальных окон и шторок
	--tui-service-underline: var(--tui-const-blue-darker-70);  // Подчеркивание для ссылок
	--tui-service-underline-hover: var(--tui-const-blue-darker-74);  // Подчеркивание для ссылок
	--tui-service-underline-pressed: var(--tui-const-blue-darker-74);  // Подчеркивание для ссылок
	...
	--tui-support-support-21: #1DACA4;  // @Deprecated: Замена на семантические цвета
	--tui-support-support-22: #F14789;  // @Deprecated: Замена на семантические цвета
	--tui-text-primary: var(--tui-const-cool-gray-lighter-97);  // Основной текст и иконки фонах base, elevation, neutral
	--tui-text-primary-pressed: var(--tui-const-cool-gray-lighter-60);  // Основной текст и иконки фонах base, elevation, neutral при нажатии
	--tui-text-primary-on-light: var(--tui-const-black-lighter-20);  // Основной текст и иконки на светлых фонах, не меняется при смене темы
	--tui-text-primary-on-light-pressed: var(--tui-const-black-lighter-60);  // Основной текст и иконки на светлых фонах, не меняется при смене темы
	--tui-text-primary-on-dark: var(--tui-const-white);  // Основной текст и иконки темных фонах. Не меняется при смене темы
	--tui-text-primary-on-dark-pressed: var(--tui-const-white-alpha-50);  // Основной текст и иконки темных фонах. Не меняется при смене темы
	...
	--tui-text-primary-on-accent-2: var(--tui-const-white);  // Текст и иконки фоне accent-2
	--tui-text-secondary: var(--tui-const-cool-gray-lighter-60);  // Второстепенный текст на фонах base, elevation, neutral
	--tui-text-secondary-pressed: var(--tui-const-cool-gray-lighter-79);  // Второстепенный текст на фонах base, elevation, neutral при нажатии
	--tui-text-secondary-on-light: var(--tui-const-black-alpha-48);  // Второстепенный текст на светлых фонах, не меняется при смене темы
	--tui-text-secondary-on-dark: var(--tui-const-white-alpha-70);  // Второстепенный текст на темных фонах, не меняется при смене темы
	--tui-text-tertiary: var(--tui-const-white-alpha-30);  // Лейблы задизейбленных кнопок, дисклеймеры
	--tui-text-tertiary-pressed: var(--tui-const-white-alpha-60);  // Лейблы задизейбленных кнопок, дисклеймеры, дисклеймеры при нажатии
	--tui-text-tertiary-on-light: var(--tui-const-cool-gray-alpha-22);  // Лейблы задизейбленных кнопок, дисклеймеры на светлых фонах, не меняется при смене темы
	--tui-text-tertiary-on-dark: var(--tui-const-white-alpha-30);  // Лейблы задизейбленных кнопок, дисклеймеры на светлых фонах, не меняется при смене темы
	...
	--tui-text-engaging: var(--tui-const-blue);  // @Deprecated: Заменён на цвет accent
	--tui-text-engaging-pressed: var(--tui-const-blue-darker-46);  // @Deprecated: Заменён на цвет accent-pressed
	--tui-text-positive: var(--tui-const-green-lighter-42);  // Текст позитивного лейбла, например пополнение счета или рост цены акций
	--tui-text-positive-on-dark: var(--tui-const-green-lighter-42);  // Текст позитивного лейбла на тёмном фоне, например пополнение счета или рост цены акций
	--tui-text-negative: var(--tui-const-red-lighter-65);  // Текст негативного лейбла, например падение цены акций или ошибка
	--tui-text-negative-on-dark: var(--tui-const-red-lighter-65);  // Текст негативного лейбла на тёмном фоне, например падение цены акций или ошибка
