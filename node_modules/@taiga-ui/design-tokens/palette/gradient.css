...
:host {
	...
	--tui-gradient-brand-all-airlines-debit: linear-gradient(241deg, rgb(81, 127, 195) 0%, rgb(50, 89, 145) 100%);
	...
	--tui-gradient-brand-pro: linear-gradient(0deg, rgb(208, 255, 149) 0%, rgb(133, 232, 8) 100%);
	...
	--tui-gradient-overlay-top: linear-gradient(0deg, rgba(0, 0, 0, 0) 30%, rgba(0, 0, 0, 0.5) 100%);
