...
const TUI_FRENCH_LANGUAGE_ADDON_DOC = {
    demoTexts: ['Mode sombre', 'Arrière-plan', 'Valeur'],
    preview: 'Aperçu',
    menuText: 'Menu',
    searchText: 'Rechercher',
    seeAlsoText: 'Voir aussi',
    tocText: 'Sur cette page',
...
export { TUI_FRENCH_LANGUAGE, TUI_FRENCH_LANGUAGE_ADDON_COMMERCE, TUI_FRENCH_LANGUAGE_ADDON_DOC, TUI_FRENCH_LANGUAGE_ADDON_EDITOR, TUI_FRENCH_LANGUAGE_ADDON_TABLE, TUI_FRENCH_LANGUAGE_CORE, TUI_FRENCH_LANGUAGE_COUNTRIES, TUI_FRENCH_LANGUAGE_KIT, TUI_FRENCH_LANGUAGE_LAYOUT };
