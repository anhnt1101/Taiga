...
const TUI_CHINESE_LANGUAGE_ADDON_DOC = {
    demoTexts: ['深色模式', '背景', '值'],
    preview: '预览',
    menuText: '菜单',
    searchText: '搜索',
...
export { TUI_CHINESE_LANGUAGE, TUI_CHINESE_LANGUAGE_ADDON_COMMERCE, TUI_CHINESE_LANGUAGE_ADDON_DOC, TUI_CHINESE_LANGUAGE_ADDON_EDITOR, TUI_CHINESE_LANGUAGE_ADDON_TABLE, TUI_CHINESE_LANGUAGE_CORE, TUI_CHINESE_LANGUAGE_COUNTRIES, TUI_CHINESE_LANGUAGE_KIT, TUI_CHINESE_LANGUAGE_LAYOUT };
