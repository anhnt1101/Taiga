 ...
 */
const TUI_DEFAULT_LANGUAGE = new InjectionToken(ngDevMode ? 'TUI_DEFAULT_LANGUAGE' : '', { factory: () => TUI_ENGLISH_LANGUAGE });
/**
 * Language for Taiga UI libraries i18n
 */
const TUI_LANGUAGE = new InjectionToken(ngDevMode ? 'TUI_LANGUAGE' : '', { factory: () => signal(inject(TUI_DEFAULT_LANGUAGE)) });
 ...
 */
const TUI_LANGUAGE_LOADER = new InjectionToken(ngDevMode ? 'TUI_LANGUAGE_LOADER' : '');

/**
 * Default key for search value in storage
 */
const TUI_LANGUAGE_STORAGE_KEY = new InjectionToken(ngDevMode ? 'TUI_LANGUAGE_STORAGE_KEY' : '', { factory: () => 'tuiLanguage' });
