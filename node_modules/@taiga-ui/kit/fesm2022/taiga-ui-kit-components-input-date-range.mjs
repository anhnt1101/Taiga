...
import { TUI_LAST_DAY, TUI_FIRST_DAY, RANGE_SEPARATOR_CHAR, DATE_RANGE_FILLER_LENGTH, TuiDayRange } from '@taiga-ui/cdk/date-time';
...
class TuiInputDateRangeDirective extends TuiInputDateBase {
    constructor() {
        super(...arguments);
        this.max = input(this.options.max ?? TUI_LAST_DAY, {
            transform: (max) => max ?? TUI_LAST_DAY,
        });
        this.min = input(this.options.min ?? TUI_FIRST_DAY, {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.25", ngImport: i0, type: TuiInputDateRangeDirective, decorators: [{
            type: Directive,
            args: [{
