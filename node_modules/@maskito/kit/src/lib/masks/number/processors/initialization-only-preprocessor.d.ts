 ...
 * ```
 */
export declare function createInitializationOnlyPreprocessor(params: Pick<Required<MaskitoNumberParams>, 'decimalPseudoSeparators' | 'decimalSeparator' | 'maximumFractionDigits' | 'minusPseudoSigns' | 'minusSign' | 'negativePattern' | 'postfix' | 'prefix'>): MaskitoPreprocessor;
