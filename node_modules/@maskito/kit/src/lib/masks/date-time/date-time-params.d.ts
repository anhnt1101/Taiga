...
interface BaseDateTimeParams extends Pick<MaskitoDateParams, 'max' | 'min'>, Pick<MaskitoTimeParams, 'dayPeriod'> {
...
export type MaskitoDateTimeParams = BaseDateTimeParams & ({
    locale: string;
    dateMode?: MaskitoDateParams['mode'];
} | {
    locale?: string;
    dateMode: MaskitoDateParams['mode'];
});
export {};
//# sourceMappingURL=date-time-params.d.ts.map