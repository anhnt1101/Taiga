...
var Styles = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      exportAs: ["tui-app-bar-button-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]){border-radius:2.75rem;margin-inline:1rem;-webkit-backdrop-filter:blur(.25rem) saturate(6) brightness(1.05);backdrop-filter:blur(.25rem) saturate(6) brightness(1.05);box-shadow:0 .5rem 2rem #00000017;overflow:hidden;box-sizing:border-box;background:var(--t-appbar-button-bg);color:var(--tui-text-primary);transition:transform var(--tui-duration) var(--tui-curve-expressive-entrance),background-color calc(var(--tui-duration) / 2) ease,color calc(var(--tui-duration) / 2) ease,box-shadow calc(var(--tui-duration) / 2) ease,backdrop-filter calc(var(--tui-duration) / 2) ease;--t-appbar-button-bg: rgba(255, 255, 255, .7);--t-appbar-glow: var(--tui-background-base);--t-appbar-bevel: linear-gradient(319deg, #fff 4%, #fff 19%, rgba(255, 255, 255, .12) 40%, rgba(255, 255, 255, .02) 45%, rgba(255, 255, 255, 0) 48%, rgba(255, 255, 255, 0) 50%, rgba(255, 255, 255, 0) 52%, rgba(255, 255, 255, .02) 55%, rgba(255, 255, 255, .12) 60%, #fff 80%, #fff 96%)}@supports not (backdrop-filter: blur(1px)){[data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]){background:var(--tui-background-elevation-1)}}[data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]):before{content:"";position:absolute;inset:0;box-sizing:border-box;border-radius:inherit;box-shadow:inset 0 0 .75rem var(--t-appbar-glow)}[data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]):after{content:"";position:absolute;inset:0;box-sizing:border-box;border-radius:inherit;pointer-events:none;padding:1px;-webkit-mask-image:linear-gradient(#000 0 0),linear-gradient(#000 0 0);mask-image:linear-gradient(#000 0 0),linear-gradient(#000 0 0);-webkit-mask-origin:content-box,border-box;mask-origin:content-box,border-box;mask-clip:content-box,border-box;background:var(--t-appbar-bevel);-webkit-mask-composite:xor;mask-composite:exclude}[data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]):active{transform:scale(1.25);filter:brightness(3)}[data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"])>[tuiIconButton]{margin:0}[data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]).tui-enter{--tui-blur: 1rem;animation-name:tuiFade,tuiBlur}[data-platform=ios].tui-liquid-glass [tuiTheme=dark] [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]),[tuiTheme=dark] [data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]),[data-platform=ios][tuiTheme=dark].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]){--t-appbar-button-bg: rgba(88, 88, 88, .31);--t-appbar-glow: var(--tui-appbar-background, rgba(31, 31, 31, .8));--t-appbar-bevel: linear-gradient(319deg, rgba(255, 255, 255, .2), rgba(255, 255, 255, .12) 19%, rgba(255, 255, 255, .04) 40%, rgba(255, 255, 255, .02) 45%, rgba(255, 255, 255, 0) 48%, rgba(255, 255, 255, 0) 50%, rgba(255, 255, 255, 0) 52%, rgba(255, 255, 255, .02) 55%, rgba(255, 255, 255, .04) 60%, rgba(255, 255, 255, .12) 80%, rgba(255, 255, 255, .2) 96%);-webkit-backdrop-filter:blur(.25rem) saturate(4);backdrop-filter:blur(.25rem) saturate(4)}[data-platform=ios].tui-liquid-glass [tuiTheme=dark] [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]):after,[tuiTheme=dark] [data-platform=ios].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]):after,[data-platform=ios][tuiTheme=dark].tui-liquid-glass [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]):after{filter:brightness(.6)}[data-platform=ios].tui-liquid-glass tui-app-bar[tuiTheme=dark] [tuiAppBarButton]:where(*[data-tui-version="5.18.0"]){--t-appbar-bevel: linear-gradient(319deg, #fff 4%, #fff 19%, rgba(255, 255, 255, .12) 40%, rgba(255, 255, 255, .02) 45%, rgba(255, 255, 255, 0) 48%, rgba(255, 255, 255, 0) 50%, rgba(255, 255, 255, 0) 52%, rgba(255, 255, 255, .02) 55%, rgba(255, 255, 255, .12) 60%, #fff 80%, #fff 96%)}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiAppBarButton = class _TuiAppBarButton {
  constructor() {
    this.styles = tuiWithStyles(Styles);
  }
  static {
  ...
  static {
    this.ɵdir = ɵɵdefineDirective({
      ...
      hostAttrs: ["data-tui-version", "5.18.0", "tuiAppBarButton", ""],
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      template: function TuiAppBarComponent_Template(rf, ctx) {
        if (rf & 1) {
          ɵɵprojectionDef(_c1);
          ɵɵtemplate(0, TuiAppBarComponent_Conditional_0_Template, 1, 0, "tui-progressive-blur");
      ...
      styles: ['tui-app-bar:where(*[data-tui-version="5.18.0"]){position:relative;display:flex;block-size:2.75rem;align-items:center;justify-content:space-between;box-sizing:border-box;font:var(--tui-typography-body-m);font-weight:700;text-align:center;color:var(--tui-text-primary);background:var(--tui-background-base);background:color-mix(in hsl,var(--tui-background-base) 80%,transparent);-webkit-backdrop-filter:blur(2rem);backdrop-filter:blur(2rem)}tui-app-bar:where(*[data-tui-version="5.18.0"])>.t-content{left:50%;transform:translate(-50%);position:absolute;display:flex;block-size:100%;max-inline-size:calc(100% - var(--t-sides, 0px));inline-size:calc(100% - var(--t-sides, 0px));flex-direction:column;justify-content:center;flex:1;padding:0 .375rem;box-sizing:border-box;text-align:inherit;white-space:nowrap}tui-app-bar:where(*[data-tui-version="5.18.0"])>.t-content progress{margin:auto}tui-app-bar:where(*[data-tui-version="5.18.0"])>:last-child [tuiIconButton]{margin:0 -.375rem}tui-app-bar:where(*[data-tui-version="5.18.0"])>:last-child [tuiIconButton]:last-child{margin-inline-end:0}tui-app-bar:where(*[data-tui-version="5.18.0"])>:last-child [tuiIconButton]:only-child{margin:0}tui-app-bar:where(*[data-tui-version="5.18.0"]) [tuiButton][data-size=l]{font:var(--tui-typography-body-l);margin:0 -.25rem}tui-app-bar:where(*[data-tui-version="5.18.0"]) [tuiTitle]{text-align:inherit;font:inherit}tui-app-bar:where(*[data-tui-version="5.18.0"]) [tuiSubtitle]{color:var(--tui-text-secondary)}tui-app-bar:where(*[data-tui-version="5.18.0"])[data-size=m] [tuiTitle]{line-height:1.2em;gap:0}tui-app-bar:where(*[data-tui-version="5.18.0"])[data-size=l]{block-size:4rem}tui-app-bar:where(*[data-tui-version="5.18.0"])[data-size=l]>:first-child,tui-app-bar:where(*[data-tui-version="5.18.0"])[data-size=l]>:last-child{margin:0 -1em}tui-app-bar:where(*[data-tui-version="5.18.0"])[data-size=l] [tuiAppBarBack]{font:var(--tui-typography-body-l)}tui-app-bar:where(*[data-tui-version="5.18.0"]) [tuiProgressBar]{inline-size:8.75rem}tui-dialog tui-app-bar[data-size=l]:where(*[data-tui-version="5.18.0"]){margin:-3rem 0 2rem}tui-dialog tui-app-bar[data-size=m]:where(*[data-tui-version="5.18.0"]){margin:-1rem -1rem .75rem}tui-sheet-dialog tui-app-bar:where(*[data-tui-version="5.18.0"]){margin:-.75rem -1rem;block-size:3.5rem;background:none;-webkit-backdrop-filter:none;backdrop-filter:none}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var Styles2 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-block-details-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]){display:flex;flex-direction:column;align-items:center;font:var(--tui-typography-heading-h3);min-block-size:2rem}[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiTitle]{text-align:center;font:var(--tui-typography-body-l);gap:0}[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiSubtitle],[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiDetailsStatus]{display:flex;align-items:center;gap:.25rem;font:var(--tui-typography-body-m);color:var(--tui-text-secondary);margin-block-start:.25rem}[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiSubtitle]+[tuiSubtitle],[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiDetailsStatus]{margin-block-start:1rem}[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiComment]{margin-block-start:1.0625rem}[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiAccessory]{display:flex;gap:.5rem;margin-block-start:1.25rem}[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiAccessories],[tuiBlockDetails]:where(*[data-tui-version="5.18.0"])>[tuiBadge]{margin-block-start:1.25rem}[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiAccessories]{display:flex;gap:.5rem}[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiAvatar],[tuiBlockDetails]:where(*[data-tui-version="5.18.0"]) [tuiTitle]{margin-block-end:1rem}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiBlockStatusComponent = class _TuiBlockStatusComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      styles: ['tui-block-status:where(*[data-tui-version="5.18.0"]){display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;box-sizing:border-box;overflow:hidden;inline-size:100%;block-size:100%}tui-block-status:where(*[data-tui-version="5.18.0"])._card{border-radius:var(--tui-radius-xl);padding:2rem}tui-block-status:where(*[data-tui-version="5.18.0"]) .t-block-image:empty,tui-block-status:where(*[data-tui-version="5.18.0"]) .t-block-text:empty,tui-block-status:where(*[data-tui-version="5.18.0"]) .t-block-actions:empty{display:none}tui-block-status:where(*[data-tui-version="5.18.0"]) .t-block-image:not(:empty){display:flex;margin-block-end:2rem}tui-block-status:where(*[data-tui-version="5.18.0"]) .t-block-text:not(:empty){font:var(--tui-typography-body-m);color:var(--tui-text-secondary);white-space:pre-line}tui-block-status:where(*[data-tui-version="5.18.0"]) .t-block-actions:not(:empty){display:flex;flex-direction:column;align-items:center;inline-size:100%;margin-block-start:2rem}tui-block-status:where(*[data-tui-version="5.18.0"]) h1,tui-block-status:where(*[data-tui-version="5.18.0"]) h2,tui-block-status:where(*[data-tui-version="5.18.0"]) h3,tui-block-status:where(*[data-tui-version="5.18.0"]) h4,tui-block-status:where(*[data-tui-version="5.18.0"]) h5,tui-block-status:where(*[data-tui-version="5.18.0"]) h6{font:var(--tui-typography-heading-h4);margin:0}tui-block-status:where(*[data-tui-version="5.18.0"]) h1~.t-block-text:not(:empty),tui-block-status:where(*[data-tui-version="5.18.0"]) h2~.t-block-text:not(:empty),tui-block-status:where(*[data-tui-version="5.18.0"]) h3~.t-block-text:not(:empty),tui-block-status:where(*[data-tui-version="5.18.0"]) h4~.t-block-text:not(:empty),tui-block-status:where(*[data-tui-version="5.18.0"]) h5~.t-block-text:not(:empty),tui-block-status:where(*[data-tui-version="5.18.0"]) h6~.t-block-text:not(:empty){margin-block-start:1rem}tui-block-status:where(*[data-tui-version="5.18.0"]) img{inline-size:9rem;block-size:9rem}tui-block-status:where(*[data-tui-version="5.18.0"]) a:not(:last-child),tui-block-status:where(*[data-tui-version="5.18.0"]) button:not(:last-child){margin-block-end:.75rem}[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h1,[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h2,[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h3,[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h4,[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h5,[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h6{font:var(--tui-typography-heading-h6);margin-block-start:0}[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h1~.t-block-text:not(:empty),[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h2~.t-block-text:not(:empty),[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h3~.t-block-text:not(:empty),[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h4~.t-block-text:not(:empty),[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h5~.t-block-text:not(:empty),[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] h6~.t-block-text:not(:empty){margin-block-start:.75rem}[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] img{inline-size:6rem;block-size:6rem}[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] .t-block-text:not(:empty){font:var(--tui-typography-body-s)}[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] .t-block-actions:not(:empty){margin-block-start:1.5rem}[data-platform=web] tui-block-status:where(*[data-tui-version="5.18.0"])[data-size=m] .t-block-image:not(:empty){margin-block-end:1.5rem}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var Styles3 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-surface-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[tuiSurface]:where(*[data-tui-version="5.18.0"]){transition-property:all;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);--tui-gap: .25rem;position:relative;box-sizing:border-box;background:none no-repeat;background-size:cover;overflow:hidden;isolation:isolate;-webkit-appearance:none;appearance:none;border:0;font-size:inherit;line-height:inherit;text-decoration:none;transition-property:backdrop-filter,background,border-radius,box-shadow,mask,transform!important}[tuiSurface]:where(*[data-tui-version="5.18.0"]):focus-visible{outline-color:var(--tui-border-focus)}@supports (not (-moz-appearance: none)) and (not (-webkit-hyphens: none)){[tuiSurface]:where(*[data-tui-version="5.18.0"]):before{mix-blend-mode:multiply}}tui-dialog[data-appearance~=taiga] [tuiSurface]:where(*[data-tui-version="5.18.0"]),tui-sheet-dialog [tuiSurface]:where(*[data-tui-version="5.18.0"]){--tui-background-elevation-1: var(--tui-background-elevation-2)}button[tuiSurface]:where(*[data-tui-version="5.18.0"]){cursor:pointer}[tuiSurface]:where(*[data-tui-version="5.18.0"]):before,[tuiSurface]:where(*[data-tui-version="5.18.0"]):after,[data-tui-version="5.18.0"] [tuiSurfaceLayer]:before,[data-tui-version="5.18.0"] [tuiSurfaceLayer]:after{position:absolute;inset-block-start:0;inset-inline-start:0;inline-size:100%;block-size:100%;transition-property:all;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);content:"";z-index:-1;border-radius:inherit;pointer-events:none;background-size:cover;background-repeat:no-repeat;transition-property:opacity,backdrop-filter,transform}[data-tui-version="5.18.0"] [tuiSurfaceLayer]{transition-property:all;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);position:absolute;inset-block-start:0;inset-inline-start:0;inline-size:100%;block-size:100%;position:absolute!important;z-index:-1;object-fit:cover;border-radius:inherit;box-sizing:border-box;transition-property:box-shadow,filter,padding}[data-tui-version="5.18.0"] input[tuiSurfaceLayer]+[tuiSurfaceLayer]{will-change:padding;background-clip:content-box;overflow:clip;overflow-clip-margin:content-box}[data-tui-version="5.18.0"] input[tuiSurfaceLayer]:checked+[tuiSurfaceLayer]{padding:var(--tui-gap)}[data-tui-version="5.18.0"] input[tuiSurfaceLayer]:focus-visible+[tuiSurfaceLayer]{padding:var(--tui-gap)}@media(hover:hover)and (pointer:fine){[tuiSurface]:where(*[data-tui-version="5.18.0"]):hover input[tuiSurfaceLayer]+[tuiSurfaceLayer]{padding:var(--tui-gap)}}[data-tui-version="5.18.0"] input[tuiSurfaceLayer]{color:var(--tui-background-accent-2);-webkit-appearance:none;appearance:none;margin:0;border-radius:inherit;outline:none;box-shadow:inset 0 0,inset 0 0 var(--tui-background-neutral-1)}[data-tui-version="5.18.0"] input[tuiSurfaceLayer]:checked{box-shadow:inset 0 0 0 calc(var(--tui-gap) / 2),inset 0 0 var(--tui-background-neutral-1)}[data-tui-version="5.18.0"] input[tuiSurfaceLayer]:focus-visible{box-shadow:inset 0 0,inset 0 0 0 calc(var(--tui-gap) / 2) var(--tui-background-neutral-1)}[data-tui-version="5.18.0"] input[tuiSurfaceLayer]:checked:focus-visible{filter:brightness(.7);box-shadow:inset 0 0 0 calc(var(--tui-gap) / 2),inset 0 0 0 calc(var(--tui-gap) / 2) var(--tui-background-neutral-1)}@media(hover:hover)and (pointer:fine){[tuiSurface]:where(*[data-tui-version="5.18.0"]):hover input[tuiSurfaceLayer]{box-shadow:inset 0 0,inset 0 0 0 calc(var(--tui-gap) / 2) var(--tui-background-neutral-1)}[tuiSurface]:where(*[data-tui-version="5.18.0"]):hover input[tuiSurfaceLayer]:checked{filter:brightness(.9);box-shadow:inset 0 0 0 calc(var(--tui-gap) / 2),inset 0 0 0 calc(var(--tui-gap) / 2) var(--tui-background-neutral-1)}}[tuiSurface][data-appearance=floating]:where(*[data-tui-version="5.18.0"]){background:var(--tui-background-elevation-1);box-shadow:var(--tui-shadow-medium)}@media(hover:hover)and (pointer:fine){[tuiSurface][data-appearance=floating]:where(*[data-tui-version="5.18.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled):hover:not([data-state]){transform:translate3d(0,-.25rem,0);box-shadow:var(--tui-shadow-medium-hover)}}[tuiSurface][data-appearance=floating]:where(*[data-tui-version="5.18.0"])[data-state=hover]{transform:translate3d(0,-.25rem,0);box-shadow:var(--tui-shadow-medium-hover)}[tuiSurface][data-appearance=floating]:where(*[data-tui-version="5.18.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled):active:not([data-state]){transform:scale(.95);background:var(--tui-background-elevation-1);box-shadow:var(--tui-shadow-medium)}[tuiSurface][data-appearance=floating]:where(*[data-tui-version="5.18.0"])[data-state=active]{transform:scale(.95);background:var(--tui-background-elevation-1);box-shadow:var(--tui-shadow-medium)}[tuiTheme=dark] [tuiSurface][data-appearance=floating]:where(*[data-tui-version="5.18.0"]),[tuiTheme=dark][tuiSurface][data-appearance=floating]:where(*[data-tui-version="5.18.0"]){box-shadow:none!important}[tuiSurface][data-appearance=neutral]:where(*[data-tui-version="5.18.0"]){background:conic-gradient(var(--tui-background-neutral-1) 0 0),conic-gradient(var(--tui-background-base) 0 0)}[tuiTheme=dark] [tuiSurface][data-appearance=neutral]:where(*[data-tui-version="5.18.0"]),[tuiTheme=dark][tuiSurface][data-appearance=neutral]:where(*[data-tui-version="5.18.0"]){background:var(--tui-background-elevation-1)}@media(hover:hover)and (pointer:fine){[tuiSurface][data-appearance=neutral]:where(*[data-tui-version="5.18.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled):hover:not([data-state]){transform:scale(1.15)}}[tuiSurface][data-appearance=neutral]:where(*[data-tui-version="5.18.0"])[data-state=hover]{transform:scale(1.15)}[tuiSurface][data-appearance=neutral]:where(*[data-tui-version="5.18.0"]):is(a,button,select,textarea,input,label,.tui-interactive):not(:disabled):active:not([data-state]){transform:scale(.95)}[tuiSurface][data-appearance=neutral]:where(*[data-tui-version="5.18.0"])[data-state=active]{transform:scale(.95)}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiSurface = class _TuiSurface {
  ...
  static {
    this.ɵdir = ɵɵdefineDirective({
      ...
      hostAttrs: ["data-tui-version", "5.18.0", "tuiSurface", ""]
    });
  }
};
(() => {
...
var Styles$3 = class Styles4 {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: Styles4,
      selectors: [["ng-component"]],
      exportAs: ["tui-card-collapsed-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[tuiCardCollapsed]:where(*[data-tui-version="5.18.0"]){transition-property:clip-path,margin!important;border-image:radial-gradient(at top,var(--tui-background-neutral-2) 26.5%,transparent 27%) 100% 49% / 0 2rem 2rem / 0 0 2rem}[tuiCardCollapsed]:where(*[data-tui-version="5.18.0"])>tui-expand{transition-property:grid-template-rows,padding,margin;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);background:var(--tui-background-neutral-1);border-radius:var(--tui-radius-s);padding:0 1rem;margin:-.25rem 0 calc(-1 * var(--t-space))!important}[tuiCardCollapsed]:where(*[data-tui-version="5.18.0"])>tui-expand._expanded{padding:.5rem 1rem;margin:0!important}[tuiCardCollapsed]:where(*[data-tui-version="5.18.0"])>tui-expand [tuiTable]{inline-size:100%}[tuiCardCollapsed]:where(*[data-tui-version="5.18.0"])>tui-expand [tuiTable] th,[tuiCardCollapsed]:where(*[data-tui-version="5.18.0"])>tui-expand [tuiTable] td{background:none;padding-inline-start:0;padding-inline-end:0;border-inline-start:0;border-inline-end:0}[tuiCardCollapsed]:where(*[data-tui-version="5.18.0"])>tui-expand [tuiTable] thead th{border:none;block-size:1.75rem}[tuiCardCollapsed]:where(*[data-tui-version="5.18.0"])>tui-expand [tuiTable] tr:last-child td{border-block-end:0}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiCardCollapsed = class _TuiCardCollapsed {
  ...
  static {
    this.ɵdir = ɵɵdefineDirective({
      ...
      hostAttrs: ["data-tui-version", "5.18.0", "tuiCardCollapsed", ""],
      hostVars: 4,
...
var Styles$2 = class Styles5 {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: Styles5,
      selectors: [["ng-component"]],
      exportAs: ["tui-card-large-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template1(rf, ctx) {
      },
      styles: ["[tuiCardMedium],[tuiCardLarge]{-webkit-appearance:none;appearance:none;padding:0;border:0;background:none;font:inherit;line-height:inherit;position:relative;display:flex;align-items:flex-start;flex-shrink:0;text-decoration:none;overflow:hidden;background:var(--tui-background-elevation-2)}[tuiCardMedium] [tuiTitle],[tuiCardLarge] [tuiTitle],[tuiCardMedium] [tuiSubtitle],[tuiCardLarge] [tuiSubtitle]{max-inline-size:100%}[tuiCardMedium]>*,[tuiCardLarge]>*{scrollbar-width:none;-ms-overflow-style:none}[tuiCardMedium]>*::-webkit-scrollbar,[tuiCardLarge]>*::-webkit-scrollbar,[tuiCardMedium]>*::-webkit-scrollbar-thumb,[tuiCardLarge]>*::-webkit-scrollbar-thumb{display:none}\n", '[tuiCardLarge]:where(*[data-tui-version="5.18.0"]){font:var(--tui-typography-body-m)}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"]){--t-space: .75rem;--t-radius: var(--tui-radius-l);--t-comp: -.25rem;--t-padding: .75rem;--t-dim: calc(var(--t-padding) + var(--t-comp));padding:var(--t-padding);border-radius:var(--t-radius);box-sizing:border-box;text-align:start}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])[data-space=normal]{--t-radius: 1.5rem;--t-padding: 1.5rem;--t-space: 1.5rem}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])[data-space=compact]{--t-radius: 1rem;--t-padding: 1.25rem;--t-space: 1.25rem}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"]):not([tuiCell],[tuiHeader],[tuiForm]){flex-direction:column;gap:var(--t-space);align-items:stretch}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"]):not([tuiCell],[tuiHeader],[tuiForm])>:last-child:not([tuiCell]){margin-block-start:auto}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])[tuiHeader]{padding:var(--t-dim) var(--t-padding)}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])[tuiHeader] [tuiButton]:last-child,[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])[tuiHeader] [tuiAvatar]:last-child,[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])[tuiHeader] [tuiSwitch]:last-child,[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])[tuiHeader] tui-segmented:last-child{margin-inline-end:var(--t-comp)}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])>[tuiHeader]{margin:var(--t-comp) 0 calc(2 * var(--t-comp))}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])>[tuiHeader] [tuiButton]:last-child,[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])>[tuiHeader] [tuiAvatar]:last-child,[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])>[tuiHeader] [tuiSwitch]:last-child,[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])>[tuiHeader] tui-segmented:last-child{margin-inline-end:var(--t-comp)}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"]) [tuiCell]:not(:where(tui-textfield *)){inline-size:100%;margin:-.5rem -.5rem -.75rem;border-radius:var(--tui-radius-l);--t-pad: .5rem}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"]) [tuiCell]:not(:where(tui-textfield *)):last-of-type{margin-block-end:-.5rem}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"]) [tuiHeader]+[tuiDescription]{margin-block:-.5rem -.25rem}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"]) [tuiHeader]+[tuiCell]{margin-block-start:var(--t-comp)}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"]) [tuiAccessories]>[tuiButtonX]{align-self:flex-start;--t-size: 1.5rem}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])>footer{margin-block-end:var(--t-comp)}[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])>footer>[tuiButton],[tuiCardLarge][data-space]:where(*[data-tui-version="5.18.0"])>footer>[tuiBlock]{margin-block-end:calc(-1 * var(--t-comp))}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var Styles$1 = class Styles6 {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: Styles6,
      selectors: [["ng-component"]],
      exportAs: ["tui-card-medium-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template2(rf, ctx) {
      },
      styles: [_c03, '[tuiCardMedium]:where(*[data-tui-version="5.18.0"]){inline-size:calc(8.75rem * var(--tui-font-scale));block-size:calc(8.75rem * var(--tui-font-scale));flex-direction:column;justify-content:space-between;padding:.75rem;border-radius:var(--tui-radius-l);box-sizing:border-box}[tuiCardMedium]:where(*[data-tui-version="5.18.0"])[tuiTitle]{padding:.625rem .75rem}[tuiCardMedium]:where(*[data-tui-version="5.18.0"]) [tuiTitle]{margin:-.125rem 0}[tuiCardMedium]:where(*[data-tui-version="5.18.0"]) [tuiSubtitle]{color:var(--tui-text-primary)}[tuiCardMedium]:where(*[data-tui-version="5.18.0"])[tuiTitle],[tuiCardMedium]:where(*[data-tui-version="5.18.0"]) [tuiTitle]:not([tuiCell] *):not([tuiLabel] *){font-weight:700}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Styles$1, [{
    ...
    args: [{
      ...
      styles: ["[tuiCardMedium],[tuiCardLarge]{-webkit-appearance:none;appearance:none;padding:0;border:0;background:none;font:inherit;line-height:inherit;position:relative;display:flex;align-items:flex-start;flex-shrink:0;text-decoration:none;overflow:hidden;background:var(--tui-background-elevation-2)}[tuiCardMedium] [tuiTitle],[tuiCardLarge] [tuiTitle],[tuiCardMedium] [tuiSubtitle],[tuiCardLarge] [tuiSubtitle]{max-inline-size:100%}[tuiCardMedium]>*,[tuiCardLarge]>*{scrollbar-width:none;-ms-overflow-style:none}[tuiCardMedium]>*::-webkit-scrollbar,[tuiCardLarge]>*::-webkit-scrollbar,[tuiCardMedium]>*::-webkit-scrollbar-thumb,[tuiCardLarge]>*::-webkit-scrollbar-thumb{display:none}\n", '[tuiCardMedium]:where(*[data-tui-version="5.18.0"]){inline-size:calc(8.75rem * var(--tui-font-scale));block-size:calc(8.75rem * var(--tui-font-scale));flex-direction:column;justify-content:space-between;padding:.75rem;border-radius:var(--tui-radius-l);box-sizing:border-box}[tuiCardMedium]:where(*[data-tui-version="5.18.0"])[tuiTitle]{padding:.625rem .75rem}[tuiCardMedium]:where(*[data-tui-version="5.18.0"]) [tuiTitle]{margin:-.125rem 0}[tuiCardMedium]:where(*[data-tui-version="5.18.0"]) [tuiSubtitle]{color:var(--tui-text-primary)}[tuiCardMedium]:where(*[data-tui-version="5.18.0"])[tuiTitle],[tuiCardMedium]:where(*[data-tui-version="5.18.0"]) [tuiTitle]:not([tuiCell] *):not([tuiLabel] *){font-weight:700}\n']
    }]
  }], null, null);
})();
...
var Styles7 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-card-row-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template3(rf, ctx) {
      },
      styles: ['[tuiCardRow]:where(*[data-tui-version="5.18.0"]){display:flex;align-items:center;gap:3rem}[tuiCardRow]:where(*[data-tui-version="5.18.0"]) tui-icon{font-size:1rem}[tuiCardRow]:where(*[data-tui-version="5.18.0"]) [tuiTitle]{font:var(--tui-typography-body-s)}[tuiCardRow]:where(*[data-tui-version="5.18.0"]) [tuiTitle]>:not([tuiSubtitle]){display:flex;align-items:center;gap:.25rem}[tuiCardRow]:where(*[data-tui-version="5.18.0"]) [tuiSubtitle]{color:var(--tui-text-secondary);font:var(--tui-typography-body-xs)}[tuiCardRow]:where(*[data-tui-version="5.18.0"])>[tuiButton],[tuiCardRow]:where(*[data-tui-version="5.18.0"])>[tuiIconButton]{margin-inline-start:auto}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
function TuiDynamicHeaderComponent_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, TuiDynamicHeaderComponent_For_1_Conditional_0_Template, 2, 1, "div", 0);
  }
  if (rf & 2) {
...
var TuiDynamicHeaderComponent = class _TuiDynamicHeaderComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      styles: ['[tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]){display:flex;block-size:100%;align-items:center;justify-content:center}[data-platform=android] [tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]){justify-content:start}[tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]) .tui-enter{animation-name:tuiFade,tuiSlide;--tui-from: translateY(calc(-200% * var(--t-dir)))}[tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]) .tui-leave{animation-name:tuiFade,tuiSlide;--tui-from: translateY(calc(200% * var(--t-dir)))}[tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]) .tui-enter:not(:first-of-type),[tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]) .tui-leave:not(:first-of-type){position:absolute}[data-platform=ios].tui-liquid-glass [tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]){--t-duration: calc(var(--tui-duration) * 5 / 3)}[data-platform=ios].tui-liquid-glass [tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]) .tui-enter{animation-name:tuiFade,tuiSlide,tuiBlur;--tui-duration: var(--t-duration);--tui-from: translateY(calc(-50% * var(--t-dir)))}[data-platform=ios].tui-liquid-glass [tuiDynamicHeader]:where(*[data-tui-version="5.18.0"]) .tui-leave{animation-name:tuiFade,tuiSlide,tuiBlur;--tui-duration: var(--t-duration);--tui-from: translateY(calc(50% * var(--t-dir)))}[data-tui-version="5.18.0"] [data-platform=ios].tui-liquid-glass [tuiDynamicHeaderContainer] [tuiHeader],[data-tui-version="5.18.0"] [data-platform=ios].tui-liquid-glass [tuiDynamicHeaderContainer] [tuiHeader] [tuiTitle]{transition:opacity var(--tui-duration) linear}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var Styles8 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-floating-container-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[tuiFloatingContainer]:where(*[data-tui-version="5.18.0"]){transition-property:inset-block-end;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);position:sticky;z-index:1;display:grid;inset-block-end:max(0px,calc(100 * var(--tui-viewport-svh) - var(--tui-viewport-height) - var(--tui-viewport-y)));inset-block-end:max(0px,calc(100svh - var(--tui-viewport-height) - var(--tui-viewport-y)));margin-block-start:1rem;padding-block-end:max(1rem,env(safe-area-inset-bottom));text-align:center;font:var(--tui-typography-ui-s);color:var(--tui-text-secondary)}[tuiFloatingContainer]:where(*[data-tui-version="5.18.0"]).tui-enter,[tuiFloatingContainer]:where(*[data-tui-version="5.18.0"]).tui-leave{animation-name:tuiSlide}[tuiFloatingContainer]:where(*[data-tui-version="5.18.0"])>*{grid-area:2 / 1}[tuiFloatingContainer]:where(*[data-tui-version="5.18.0"])>*:first-child{grid-row:1;margin-block-end:.5rem}[tuiFloatingContainer]:where(*[data-tui-version="5.18.0"]):before{inset-block-start:0;inset-inline-start:0;inset-block-end:0;inset-inline-end:0;transition-property:background;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);content:"";position:absolute;z-index:-1;inset-inline-start:-1rem;inset-inline-end:-1rem;background:var(--t-background, var(--tui-background-elevation-1));-webkit-mask-image:linear-gradient(180deg,transparent,black 2.5rem);mask-image:linear-gradient(180deg,transparent,black 2.5rem)}tui-sheet-dialog [tuiFloatingContainer]:where(*[data-tui-version="5.18.0"]){margin-block-end:calc(-1*max(1.5rem,env(safe-area-inset-bottom)))}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiFloatingContainer = class _TuiFloatingContainer {
  ...
  static {
    this.ɵdir = ɵɵdefineDirective({
      ...
      hostAttrs: ["data-tui-version", "5.18.0", "tuiFloatingContainer", ""],
      hostVars: 2,
...
var Styles9 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-header-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[tuiHeader]:where(*[data-tui-version="5.18.0"]){position:relative;display:flex;align-items:flex-start;box-sizing:content-box;color:var(--tui-text-primary);margin:0;gap:.5rem 1rem;text-align:start;overflow-wrap:break-word}[tuiHeader]:where(*[data-tui-version="5.18.0"]) p{margin:.25rem 0 0;font:var(--tui-typography-body-m)}[tuiHeader]:where(*[data-tui-version="5.18.0"]) p:empty{display:none}[tuiHeader]:where(*[data-tui-version="5.18.0"]) [tuiTitle]{max-inline-size:fit-content;flex:1 0 60%;margin:0;margin-inline-end:auto;font:inherit}[tuiHeader]:where(*[data-tui-version="5.18.0"]) [tuiTitle]:empty{display:none}[tuiHeader]:where(*[data-tui-version="5.18.0"]) [tuiAccessories]{display:flex;align-items:center;gap:.75rem;white-space:nowrap}[tuiHeader]:where(*[data-tui-version="5.18.0"]) [tuiAccessories]:has([tuiLink]){align-items:baseline}[tuiHeader]:where(*[data-tui-version="5.18.0"]) [tuiAccessories]:before{content:"\\200b";visibility:hidden;margin-inline-end:-.75rem}[tuiHeader]:where(*[data-tui-version="5.18.0"]) [tuiSubtitle]{color:var(--tui-text-secondary)}[tuiHeader]:where(*[data-tui-version="5.18.0"]) [tuiCaption]{font:var(--tui-typography-body-s);color:var(--tui-text-secondary);font-weight:500;text-transform:uppercase;margin:0}[tuiHeader]:where(*[data-tui-version="5.18.0"])+[tuiDescription]{margin-block-start:.5rem;color:var(--tui-text-primary);font:var(--tui-typography-body-m)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h1]{font:var(--tui-typography-heading-h1)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h1]+[tuiDescription]{margin-block-start:.75rem}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h2]{font:var(--tui-typography-heading-h2)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h3]{font:var(--tui-typography-heading-h3)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h4]{font:var(--tui-typography-heading-h4)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h5]{font:var(--tui-typography-heading-h5)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h6]{font:var(--tui-typography-heading-h6)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-l]{font:var(--tui-typography-body-l)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-m]{font:var(--tui-typography-ui-l)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-s]{font:var(--tui-typography-ui-m)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-s] [tuiTitle]{gap:.125rem}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-s]+[tuiDescription]{margin-block-start:.125rem}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-m] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-s] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-m] [tuiAccessories] [tuiLink],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-s] [tuiAccessories] [tuiLink]{font:var(--tui-typography-body-s)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h1] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h2] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h3] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h1] [tuiAccessories] [tuiLink],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h2] [tuiAccessories] [tuiLink],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h3] [tuiAccessories] [tuiLink],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h1]+[tuiDescription],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h2]+[tuiDescription],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h3]+[tuiDescription]{font:var(--tui-typography-body-l)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h4] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h5] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h6] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-l] [tuiSubtitle],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h4] [tuiAccessories] [tuiLink],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h5] [tuiAccessories] [tuiLink],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=h6] [tuiAccessories] [tuiLink],[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size=body-l] [tuiAccessories] [tuiLink]{font:var(--tui-typography-body-m)}[tuiHeader]:where(*[data-tui-version="5.18.0"])[data-size] [tuiTitle]{font-weight:700}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiHeader = class _TuiHeader {
  ...
  static {
    this.ɵdir = ɵɵdefineDirective({
      type: _TuiHeader,
      selectors: [["", "tuiHeader", ""]],
      hostAttrs: ["data-tui-version", "5.18.0", "tuiHeader", ""],
      hostVars: 1,
...
var Styles10 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-form-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['@keyframes safariIsAJoke{to{opacity:.999}}[tuiForm]:where(*[data-tui-version="5.18.0"])[tuiForm]{display:flex;flex-direction:column;align-items:stretch}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=s]{gap:.75rem;font:var(--tui-typography-body-s)}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=s] tui-error,[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=s] tui-elastic-container{margin-block-start:-.75rem}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=s] legend{font:var(--tui-typography-ui-m)}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=m]{gap:1rem;font:var(--tui-typography-body-s)}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=m] tui-error,[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=m] tui-elastic-container{margin-block-start:-1rem}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=m] legend{font:var(--tui-typography-ui-l)}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=l]{gap:1.25rem;font:var(--tui-typography-body-m)}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=l] tui-error,[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=l] tui-elastic-container{margin-block-start:-1.25rem}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=l] legend{font:var(--tui-typography-ui-l)}[tuiForm]:where(*[data-tui-version="5.18.0"]) fieldset{display:grid;flex-wrap:wrap;gap:inherit;grid-template-columns:repeat(auto-fit,minmax(10rem,1fr));border:none;padding:0;margin:0;animation:safariIsAJoke 1ms}[tuiForm]:where(*[data-tui-version="5.18.0"]) fieldset legend:defined{position:relative;inline-size:100%;padding:.5rem 0 .75rem;font-weight:700}[tuiForm]:where(*[data-tui-version="5.18.0"])>fieldset:first-child>legend{inset-block-start:-.25rem;padding:0 0 .5rem}[tuiForm]:where(*[data-tui-version="5.18.0"])>header{padding-block-end:.25rem}[tuiForm]:where(*[data-tui-version="5.18.0"])>footer{display:flex;gap:.75rem;margin-block-start:.25rem}tui-dialog [tuiForm]:where(*[data-tui-version="5.18.0"])>footer{justify-content:flex-end}[tuiForm]:where(*[data-tui-version="5.18.0"])>button,[tuiForm]:where(*[data-tui-version="5.18.0"])>a{align-self:flex-start}[tuiForm]:where(*[data-tui-version="5.18.0"]) tui-elastic-container{display:flex}[tuiForm]:where(*[data-tui-version="5.18.0"]) tui-elastic-container>*>.tui-enter,[tuiForm]:where(*[data-tui-version="5.18.0"]) tui-elastic-container>*>.tui-leave{animation-name:tuiFade}[tuiForm]:where(*[data-tui-version="5.18.0"]) tui-elastic-container:not(:has(>*>*:not(.tui-leave))){block-size:0!important}[tuiForm]:where(*[data-tui-version="5.18.0"]) [tuiLabel]:not([data-orientation=vertical]){font:inherit}[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=s] [tuiLabel]:not([data-orientation=vertical]) [tuiTooltip],[tuiForm]:where(*[data-tui-version="5.18.0"])[data-size=m] [tuiLabel]:not([data-orientation=vertical]) [tuiTooltip]{block-size:1.25rem}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiForm = class _TuiForm {
  ...
  static {
    this.ɵdir = ɵɵdefineDirective({
      type: _TuiForm,
      selectors: [["", "tuiForm", ""]],
      hostAttrs: ["data-tui-version", "5.18.0", "tuiForm", ""],
      hostVars: 1,
    ...
    this.ɵcmp = ɵɵdefineComponent({
      ...
      hostBindings: function TuiInputSearchContent_HostBindings(rf, ctx) {
        if (rf & 1) {
          ...
          }, false, ɵɵresolveDocument)("keydown.esc", function TuiInputSearchContent_keydown_esc_HostBindingHandler() {
...
var Styles11 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-item-group-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[tuiItemGroup]:where(*[data-tui-version="5.18.0"]){display:flex;flex-wrap:wrap;--tui-item-margin: .25rem}[tuiItemGroup]:where(*[data-tui-version="5.18.0"])>*:not(tui-items-with-more){margin:0 var(--tui-item-margin) var(--tui-item-margin) 0}[tuiItemGroup]:where(*[data-tui-version="5.18.0"])._horizontal{scrollbar-width:none;-ms-overflow-style:none;flex-wrap:nowrap;overflow:scroll}[tuiItemGroup]:where(*[data-tui-version="5.18.0"])._horizontal::-webkit-scrollbar,[tuiItemGroup]:where(*[data-tui-version="5.18.0"])._horizontal::-webkit-scrollbar-thumb{display:none}[tuiItemGroup]:where(*[data-tui-version="5.18.0"])._horizontal>*:not(tui-items-with-more){margin-block-end:0}[tuiItemGroup]:where(*[data-tui-version="5.18.0"])._initialized tui-items-with-more .t-item{transition-property:transform,opacity;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);opacity:1;transform:scale(1)}[tuiItemGroup]:where(*[data-tui-version="5.18.0"])._initialized tui-items-with-more .t-item>*{margin:0 var(--tui-item-margin) var(--tui-item-margin) 0}[tuiItemGroup]:where(*[data-tui-version="5.18.0"])._initialized tui-items-with-more .t-item_hidden{opacity:0;transform:scale(.9)}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var Styles12 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-list-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[tuiList]:where(*[data-tui-version="5.18.0"]){list-style:none;padding:.25rem 0;margin-block:0;counter-reset:item;margin-inline-start:1.5rem}[tuiList]:where(*[data-tui-version="5.18.0"]) [tuiList]{padding:0;margin-inline-start:1.25rem}[tuiList]:where(*[data-tui-version="5.18.0"])>li{counter-increment:item;margin:.5rem 0}[tuiList]:where(*[data-tui-version="5.18.0"])>li:before{content:counters(item,".") ".";display:inline-flex;margin:0 .5625rem 0 -1.5rem}[tuiList]:where(*[data-tui-version="5.18.0"]):is(ul)>li:before{color:transparent;background:radial-gradient(circle .1875rem,var(--tui-list-marker, var(--tui-status-info)) 100%,transparent 101%);inline-size:.75rem;margin-inline-end:.75rem}[tuiList]:where(*[data-tui-version="5.18.0"]):is(ol)>li:before{unicode-bidi:isolate;font-variant-numeric:tabular-nums}[tuiList]:where(*[data-tui-version="5.18.0"])[data-size=l]{font:var(--tui-typography-body-l)}[tuiList]:where(*[data-tui-version="5.18.0"])[data-size=l]:is(ul)>li:before{inline-size:.875rem;margin:0 .5625rem 0 -1.4375rem}[tuiList]:where(*[data-tui-version="5.18.0"])[data-size=m]{font:var(--tui-typography-body-m)}[tuiList]:where(*[data-tui-version="5.18.0"])[data-size=s]{font:var(--tui-typography-ui-s)}[tuiList]:where(*[data-tui-version="5.18.0"])[data-size=s]>li{margin:.625rem 0}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var _c142 = ["*", [["tui-tabs"], ["tui-tabs-with-more"]], [["", "tuiButton", ""], ["", "tuiIconButton", ""]]];
var _c15 = ["*", "tui-tabs,tui-tabs-with-more", "[tuiButton],[tuiIconButton]"];
var _c16 = '[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]){z-index:1;inset-block-start:3rem;block-size:var(--tui-height-m);padding-block-start:.25rem;border-image:conic-gradient(var(--tui-background-base) 0 0) fill 0/0/0 100vw}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]):before{content:"";display:block;block-size:100%;border-image:linear-gradient(0deg,var(--tui-border-normal) 1px,transparent 0) fill 0/0/0 100vw}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader{position:absolute;display:flex;inset-block-start:0;inset-inline-start:0;inset-inline-end:0;block-size:inherit;align-items:center;gap:.5rem;font:var(--tui-typography-body-s);white-space:nowrap;overflow:hidden;padding:inherit}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader tui-breadcrumbs{flex:1;overflow:hidden}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader>tui-tabs,[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader>tui-tabs-with-more{margin-inline-start:auto;margin-inline-end:1.5rem;border-inline-start:3rem solid transparent;box-shadow:none}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader tui-tabs:before,[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader tui-tabs-with-more:before{background:var(--tui-background-accent-opposite-pressed)}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]){margin-block-start:.875rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader]{margin:1rem 0 .5rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader]:first-child{margin-block-start:0}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader] [tuiTitle]{max-inline-size:42rem;margin-inline-end:auto}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader] [tuiSubtitle]{font:var(--tui-typography-body-s)}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader] [tuiSubtitle] tui-icon{font-size:1rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader]+tui-textfield{margin-block-start:.75rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs{margin-block-start:.5rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs:before{background:var(--tui-background-accent-opposite-pressed)}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs [tuiButton],[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs [tuiIconButton]{margin-inline-start:.5rem;align-self:center}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs [tuiTab]+[tuiButton],[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs [tuiTab]+[tuiIconButton]{margin-inline-start:auto}\n';
var TuiAsideComponent = class _TuiAsideComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      hostAttrs: ["data-tui-version", "5.18.0", "tuiNavigationAside", "", "tuiTheme", "dark"],
      hostVars: 2,
      ...
      decls: 6,
      vars: 0,
      consts: [["tuiFade", "vertical", "tuiScrollRef", "", 1, "t-nav-scrollbar"], [1, "t-nav-content"]],
      template: function TuiAsideComponent_Template(rf, ctx) {
        if (rf & 1) {
          ɵɵprojectionDef(_c14);
          ɵɵprojection(0);
          ɵɵelementStart(1, "div", 0);
          ɵɵelement(2, "tui-scroll-controls");
          ɵɵelementStart(3, "div", 1);
          ɵɵprojection(4, 1);
          ɵɵelementEnd()();
          ɵɵprojection(5, 2);
      ...
      dependencies: [TuiFade, TuiScrollControls, TuiScrollRef],
      styles: ['aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]){transition-property:width;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);position:sticky;z-index:1;display:flex;inset-block-start:3rem;inset-inline-start:0;inline-size:3rem;min-block-size:0;flex-direction:column;padding:.5rem .5rem .25rem;box-sizing:border-box;background:var(--tui-theme-color, #000);color:var(--tui-text-primary)}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]):before{content:"";position:absolute;z-index:-1;inset-block-start:0;inset-inline-start:100%;block-size:3rem;inline-size:3rem;pointer-events:none;border-top-left-radius:1.25rem;box-shadow:-1.5rem 0 var(--tui-theme-color, #000);transform:scaleX(var(--tui-inline));clip-path:inset(0)}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"])._expanded{inline-size:14.375rem}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"])._expanded+main[tuiNavigationMain]{max-inline-size:calc(100% - 14.375rem)}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) .t-nav-scrollbar{scrollbar-width:none;-ms-overflow-style:none;display:flex;block-size:100%;overflow:auto}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) .t-nav-scrollbar::-webkit-scrollbar,aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) .t-nav-scrollbar::-webkit-scrollbar-thumb{display:none}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) .t-nav-content{inline-size:100%;block-size:fit-content}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) tui-expand [tuiAsideItem]{padding-inline-start:2rem}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) hr{background:var(--tui-border-normal);block-size:1px;margin:0 0 .25rem;border:none}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) header{padding-block-end:.25rem;box-shadow:inset 0 -1px var(--tui-border-normal);margin-block-end:1rem}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) footer{display:flex;flex-direction:column;flex:1}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"]) footer:before{content:"";min-block-size:1.75rem;margin:0 -.5rem;flex:1;-webkit-mask-image:linear-gradient(transparent 0,black 3rem,black calc(100% - 3rem),transparent 100%);mask-image:linear-gradient(transparent 0,black 3rem,black calc(100% - 3rem),transparent 100%)}aside[tuiNavigationAside]:where(*[data-tui-version="5.18.0"])+main[tuiNavigationMain]{max-inline-size:calc(100% - 3rem)}[tuiAsideItem][tuiAsideItem]:where(*[data-tui-version="5.18.0"]){inline-size:100%;justify-content:flex-start;gap:.625rem;margin-block-end:.25rem}[tuiAsideItem][tuiAsideItem]:where(*[data-tui-version="5.18.0"]):after{border:none!important;margin-inline-start:auto!important;color:var(--tui-text-tertiary)}[tuiAsideItem][tuiAsideItem]:where(*[data-tui-version="5.18.0"]).tui-dropdown-open,[tuiAsideItem][tuiAsideItem]:where(*[data-tui-version="5.18.0"])._active:not(._chevron-rotated),aside[tuiNavigationAside]:not(._expanded) [tuiAsideItem][tuiAsideItem]:where(*[data-tui-version="5.18.0"])._active{background:var(--tui-background-neutral-1-hover)}[data-tui-version="5.18.0"] tui-dropdown[data-appearance=dropdown-navigation]{border:none;background:var(--tui-background-elevation-3);background:color-mix(in srgb,var(--tui-theme-color, #000) 80%,#fff)}[data-tui-version="5.18.0"] tui-dropdown[data-appearance=dropdown-navigation] [tuiAsideItem]{margin:0}[data-tui-version="5.18.0"] tui-dropdown[data-appearance=dropdown-navigation] [tuiAsideItem]._active{background:transparent}[data-tui-version="5.18.0"] tui-dropdown[data-appearance=dropdown-navigation] [tuiAsideItem]._link:not(._custom):after{opacity:0}[data-tui-version="5.18.0"] tui-dropdown[data-appearance=dropdown-navigation] [tuiAsideItem]._link._active:after{opacity:1}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      contentQueries: function TuiAsideGroupComponent_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
          ɵɵcontentQuerySignal(dirIndex, ctx.chevron, TuiChevron, 5);
      ...
      viewQuery: function TuiAsideGroupComponent_Query(rf, ctx) {
        if (rf & 1) {
          ɵɵviewQuerySignal(ctx.datalist, _c32, 5);
        }
        if (rf & 2) {
          ɵɵqueryAdvance();
        }
...
var TuiHeaderComponent = class _TuiHeaderComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      hostAttrs: ["data-tui-version", "5.18.0", "tuiTheme", "dark"],
      features: [ɵɵProvidersFeature([tuiAvatarOptionsProvider({
        size: "s",
        appearance: "secondary-grayscale"
      }), tuiBadgeNotificationOptionsProvider({
      ...
      styles: ['header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]){position:sticky;z-index:2;display:flex;inset-block-start:0;inset-inline-start:0;block-size:3rem;inline-size:100vw;align-items:center;gap:.25rem;padding:.5rem;box-sizing:border-box;font:var(--tui-typography-body-s);background:var(--tui-theme-color, #000);color:var(--tui-text-primary);box-shadow:0 -100rem 0 100rem var(--tui-theme-color, #000)}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]):before{content:"";position:absolute;z-index:-1;inset-block-start:100%;inset-inline:0;block-size:3rem;pointer-events:none;box-shadow:0 -1.5rem var(--tui-theme-color, #000);border-radius:1.25rem 1.25rem 0 0;clip-path:inset(0)}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) [tuiNavigationLogo]{padding:0 .5rem;margin:0 1rem}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) [tuiNavigationLogo] tui-icon{font-size:1rem}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) [tuiNavigationSegments]{display:flex;gap:.5rem;min-inline-size:12rem}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) [tuiNavigationSegments]>*:not(:last-child){flex:1 0 auto}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) [tuiNavigationSegments]>*:last-child{min-inline-size:3rem;flex:1 1 auto}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) [tuiButton],header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) [tuiBadge],header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) [tuiChip],header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) tui-badge{max-inline-size:12.5rem}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) hr{flex:1;block-size:calc(100% + 1rem);min-inline-size:4rem;margin:-.5rem 0;border:none;flex-shrink:0;background:transparent;-webkit-mask-image:linear-gradient(to right,transparent 0,black 3rem,black calc(100% - 3rem),transparent 100%);mask-image:linear-gradient(to right,transparent 0,black 3rem,black calc(100% - 3rem),transparent 100%)}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) hr~[tuiButton]{margin-inline-end:.5rem}header[tuiNavigationHeader][tuiNavigationHeader]:where(*[data-tui-version="5.18.0"]) tui-textfield{inline-size:12rem;margin-inline-end:1.75rem}tui-dropdown[data-appearance=dropdown-navigation]:where(*[data-tui-version="5.18.0"]){border:none;color:var(--tui-text-primary);background:var(--tui-background-elevation-3);background:color-mix(in srgb,var(--tui-theme-color, #000) 80%,#fff)}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiLogoComponent = class _TuiLogoComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      styles: ['[tuiNavigationLogo]:where(*[data-tui-version="5.18.0"]){display:flex;align-items:center;gap:.5rem;overflow:hidden;white-space:nowrap;font-weight:700}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiMainComponent = class _TuiMainComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      hostAttrs: ["data-tui-version", "5.18.0", "tuiNavigationMain", ""],
      attrs: _c8,
      ngContentSelectors: _c42,
      decls: 1,
      vars: 0,
      ...
      styles: ['main[tuiNavigationMain]:where(*[data-tui-version="5.18.0"]){transition-property:max-width;transition-duration:var(--tui-duration, .3s);transition-timing-function:var(--tui-curve-productive-standard);position:relative;display:grid;grid-template-columns:repeat(12,minmax(0,8.5625rem));align-items:start;gap:1rem;place-content:start center;flex:1;border:1.5rem solid transparent;border-block-start:0;isolation:isolate;box-sizing:border-box}main[tuiNavigationMain]:where(*[data-tui-version="5.18.0"])>*{grid-column:span 12;max-inline-size:100%}main[tuiNavigationMain]:where(*[data-tui-version="5.18.0"])>nav[tuiNavigationNav]:not(:first-child){border-image:conic-gradient(var(--tui-background-base) 0 0) fill 0/0/0 100vw;box-shadow:inset 0 -1px var(--tui-border-normal)}main[tuiNavigationMain]:where(*[data-tui-version="5.18.0"])>a:first-child,main[tuiNavigationMain]:where(*[data-tui-version="5.18.0"])>button:first-child,main[tuiNavigationMain]:where(*[data-tui-version="5.18.0"])>tui-breadcrumbs:first-child{block-size:1.25rem;padding:0;margin-block-start:.875rem;justify-self:flex-start}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiNavComponent = class _TuiNavComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      styles: ['nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"]){z-index:1;display:flex;inset-block-start:3rem;min-block-size:3rem;align-items:center;gap:.5rem;padding:.25rem 0 0;box-sizing:border-box;white-space:nowrap;overflow:hidden;font:var(--tui-typography-body-s);color:var(--tui-text-secondary);border-image:linear-gradient(0deg,var(--tui-border-normal) 1px,var(--tui-background-base) 0) fill 0/0/0 100vw}nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"]) [tuiNavigationLogo]{font:var(--tui-typography-body-m);font-weight:700;color:var(--tui-text-primary)}nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"])>a{text-decoration:none;color:inherit}nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"])>hr{inline-size:2rem;margin:0 0 0 auto;border:none;visibility:hidden;flex-shrink:0}nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"]) tui-icon{font-size:1rem;vertical-align:bottom}nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"]) tui-tabs,nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"]) [tuiTabs]{box-shadow:none;margin-inline-end:1rem}nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"]) tui-tabs:before,nav[tuiNavigationNav]:where(*[data-tui-version="5.18.0"]) [tuiTabs]:before{background:var(--tui-background-accent-opposite-pressed)}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiSubheaderComponent = class _TuiSubheaderComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      styles: ['[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]){z-index:1;inset-block-start:3rem;block-size:var(--tui-height-m);padding-block-start:.25rem;border-image:conic-gradient(var(--tui-background-base) 0 0) fill 0/0/0 100vw}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]):before{content:"";display:block;block-size:100%;border-image:linear-gradient(0deg,var(--tui-border-normal) 1px,transparent 0) fill 0/0/0 100vw}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader{position:absolute;display:flex;inset-block-start:0;inset-inline-start:0;inset-inline-end:0;block-size:inherit;align-items:center;gap:.5rem;font:var(--tui-typography-body-s);white-space:nowrap;overflow:hidden;padding:inherit}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader tui-breadcrumbs{flex:1;overflow:hidden}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader>tui-tabs,[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader>tui-tabs-with-more{margin-inline-start:auto;margin-inline-end:1.5rem;border-inline-start:3rem solid transparent;box-shadow:none}[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader tui-tabs:before,[tuiSubheader][compact]:where(*[data-tui-version="5.18.0"]) .t-nav-subheader tui-tabs-with-more:before{background:var(--tui-background-accent-opposite-pressed)}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]){margin-block-start:.875rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader]{margin:1rem 0 .5rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader]:first-child{margin-block-start:0}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader] [tuiTitle]{max-inline-size:42rem;margin-inline-end:auto}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader] [tuiSubtitle]{font:var(--tui-typography-body-s)}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader] [tuiSubtitle] tui-icon{font-size:1rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) [tuiHeader]+tui-textfield{margin-block-start:.75rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs{margin-block-start:.5rem}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs:before{background:var(--tui-background-accent-opposite-pressed)}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs [tuiButton],[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs [tuiIconButton]{margin-inline-start:.5rem;align-self:center}[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs [tuiTab]+[tuiButton],[tuiSubheader]:not([compact]):where(*[data-tui-version="5.18.0"]) tui-tabs [tuiTab]+[tuiIconButton]{margin-inline-start:auto}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var _c07 = ["*", [["", "tuiTitle", ""]], [["button"]]];
var _c17 = ["*", "[tuiTitle]", "button"];
...
function TuiPdfViewer_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(3, TuiPdfViewer_ng_template_3_Conditional_3_Template, 2, 2, "button", 9);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
var TuiPdfViewer = class _TuiPdfViewer {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      styles: ['tui-pdf-viewer:where(*[data-tui-version="5.18.0"]){position:relative;z-index:1;display:flex;flex-direction:column;inline-size:100vw;block-size:100%;flex:1;box-sizing:border-box;color:var(--tui-text-primary);--t-header: 3.5rem}tui-root:not(._mobile) tui-pdf-viewer:where(*[data-tui-version="5.18.0"]){background:#000}tui-root:not(._mobile) tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) [tuiTitle]{margin-inline-end:auto}tui-root:not(._mobile) tui-dialog tui-pdf-viewer:where(*[data-tui-version="5.18.0"]){margin:-6rem calc(-1 * calc(50vw - var(--tui-width) / 2)) -2rem}tui-root._mobile tui-dialog tui-pdf-viewer:where(*[data-tui-version="5.18.0"]){--t-header: 2.5rem;margin:0 -1rem -1rem}tui-root._mobile tui-dialog tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) tui-app-bar{margin:calc(-1*env(safe-area-inset-top)) 0 0}tui-sheet-dialog[data-appearance=fullscreen] tui-pdf-viewer:where(*[data-tui-version="5.18.0"]){--t-header: 4.5rem;margin:0 -1rem -1.5rem}tui-sheet-dialog[data-appearance=fullscreen] tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) tui-app-bar{margin:0}tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) .t-header{display:flex;gap:.5rem;align-items:center;block-size:var(--t-header);padding:0 .75rem 0 1rem;justify-content:flex-end}tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) .t-content{display:flex;flex:1;overflow:hidden;justify-content:center}tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) tui-loader,tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) tui-block-status{inline-size:100%;margin-block-start:calc(-1 * var(--t-header))}tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) iframe{inline-size:100%;border:none}tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) [tuiButton][data-appearance=""],tui-pdf-viewer:where(*[data-tui-version="5.18.0"]) [tuiIconButton][data-appearance=""]{color:var(--tui-text-primary);background:#4d4d4d;border-radius:5rem}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
function TuiSearchFiltersComponent_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, TuiSearchFiltersComponent_For_1_Conditional_0_Template, 1, 1, "ng-container", 3);
  }
  if (rf & 2) {
...
function TuiSearchFiltersComponent_Conditional_4_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, TuiSearchFiltersComponent_Conditional_4_For_5_Conditional_0_Template, 1, 1, "ng-container", 3);
  }
  if (rf & 2) {
...
var TuiSearchComponent = class _TuiSearchComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      styles: ['search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form{display:flex;flex-direction:column;gap:.75rem}search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form fieldset{display:flex;align-items:center;flex-wrap:wrap;gap:inherit;min-inline-size:0;padding:0;margin:0;border:0;color:var(--tui-text-secondary)}search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form tui-items-with-more{min-inline-size:0;flex:1}search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form tui-textfield,search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form [tuiSearchField]{flex:1;min-inline-size:11.25rem;max-inline-size:22.5rem}search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form tui-textfield:first-child,search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form [tuiSearchField]:first-child{max-inline-size:unset}search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form hr{inline-size:1px;block-size:1rem;border:none;margin:0;background:var(--tui-border-normal)}search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form tui-filter{white-space:nowrap}search[tuiSearch]:where(*[data-tui-version="5.18.0"]) form [tuiLabel]{font:inherit}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
    ...
    this.ɵcmp = ɵɵdefineComponent({
      ...
      contentQueries: function TuiSearchFiltersComponent_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
          ...
          ɵɵcontentQuerySignal(dirIndex, ctx.templates, TuiItem, 5, TemplateRef);
        }
        if (rf & 2) {
          ɵɵqueryAdvance(2);
        }
      ...
      viewQuery: function TuiSearchFiltersComponent_Query(rf, ctx) {
        if (rf & 1) {
          ɵɵviewQuerySignal(ctx.rem, _c33, 5);
          ɵɵviewQuerySignal(ctx.button, TuiButton, 5, ElementRef);
        }
        if (rf & 2) {
          ɵɵqueryAdvance(2);
        }
      ...
      template: function TuiSearchFiltersComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          ɵɵelement(2, "div", 1, 0);
          ɵɵtemplate(4, TuiSearchFiltersComponent_Conditional_4_Template, 6, 4, "button", 2);
        }
        if (rf & 2) {
...
var Styles13 = class _Styles {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _Styles,
      selectors: [["ng-component"]],
      exportAs: ["tui-slides-5.18.0"],
      decls: 0,
      vars: 0,
      template: function Styles_Template(rf, ctx) {
      },
      styles: ['[tuiSlides]:where(*[data-tui-version="5.18.0"]){display:grid!important;isolation:isolate}[tuiSlides]:where(*[data-tui-version="5.18.0"])[data-direction="-1"]>*{--tui-from: translateX(-2rem)}[tuiSlides]:where(*[data-tui-version="5.18.0"])[data-direction="-1"]>*.tui-leave{--tui-from: translateX(1rem)}[tuiSlides]:where(*[data-tui-version="5.18.0"])[data-direction="1"]>*{--tui-from: translateX(2rem)}[tuiSlides]:where(*[data-tui-version="5.18.0"])[data-direction="1"]>*.tui-leave{--tui-from: translateX(-1rem)}[tuiSlides]:where(*[data-tui-version="5.18.0"])>*{grid-area:1 / 1;align-self:start;mix-blend-mode:plus-lighter;animation-name:tuiFade,tuiSlide;animation-duration:var(--tui-duration);animation-timing-function:ease-in-out;animation-fill-mode:both;--tui-from: translateY(0)}[tuiSlides]:where(*[data-tui-version="5.18.0"])>*.tui-slide:not(.tui-leave){animation-name:none}[tuiSlides]:where(*[data-tui-version="5.18.0"])>*.tui-leave{margin-block-end:-100rem}\n'],
      encapsulation: 2,
      changeDetection: 0
    });
  }
...
var TuiSlides = class _TuiSlides {
  ...
  static {
    this.ɵdir = ɵɵdefineDirective({
      type: _TuiSlides,
      selectors: [["", "tuiSlides", ""]],
      hostAttrs: ["data-tui-version", "5.18.0", "tuiSlides", ""],
      hostVars: 1,
