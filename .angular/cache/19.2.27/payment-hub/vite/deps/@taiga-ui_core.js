...
function TuiCarouselComponent_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r1.template())("ngTemplateOutletContext", ɵɵpureFunction1(2, _c0, ctx_r1.index()));
  }
}
...
function TuiCarouselComponent_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r1.template())("ngTemplateOutletContext", ɵɵpureFunction1(2, _c0, ctx_r1.math.min(ctx_r1.index() + 1, ctx_r1.max())));
  }
}
    ...
    this.ɵcmp = ɵɵdefineComponent({
      ...
      template: function TuiCarouselComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          ɵɵelementEnd()();
          ɵɵtemplate(4, TuiCarouselComponent_Conditional_4_Template, 3, 4, "span", 0)(5, TuiCarouselComponent_Conditional_5_Template, 4, 4, "span", 0);
        }
        if (rf & 2) {
          ɵɵadvance();
          ɵɵproperty("ngTemplateOutlet", ctx.template())("ngTemplateOutletContext", ɵɵpureFunction1(4, _c0, ctx.math.max(ctx.index() - 1, ctx.min())));
          ɵɵadvance(3);
...
function TuiErrorComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("polymorpheusOutlet", error_r2.message || ctx_r2.default())("polymorpheusOutletContext", error_r2.context || ɵɵpureFunction0(2, _c02));
  }
}
...
// node_modules/@taiga-ui/core/fesm2022/taiga-ui-core-portals-close.mjs
var TuiClose = class _TuiClose {
  constructor() {
    this.tuiClose = outputFromObservable(inject(TuiDialogCloseService));
  }
  static {
    this.ɵfac = function TuiClose_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _TuiClose)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
